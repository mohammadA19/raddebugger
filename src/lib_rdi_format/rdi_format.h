...
struct RDI_U32_StringTable                 { RDI_U32 v; } RDI_U32_StringTable;
struct RDI_U32_IndexRuns                   { RDI_U32 v; } RDI_U32_IndexRuns;
struct RDI_U32_BinarySections              { RDI_U32 v; } RDI_U32_BinarySections;
struct RDI_U32_FilePathNodes               { RDI_U32 v; } RDI_U32_FilePathNodes;
struct RDI_U32_SourceFiles                 { RDI_U32 v; } RDI_U32_SourceFiles;
struct RDI_U32_LineTables                  { RDI_U32 v; } RDI_U32_LineTables;
struct RDI_U32_LineInfoVOffs               { RDI_U32 v; } RDI_U32_LineInfoVOffs;
struct RDI_U32_LineInfoLines               { RDI_U32 v; } RDI_U32_LineInfoLines;
struct RDI_U32_LineInfoColumns             { RDI_U32 v; } RDI_U32_LineInfoColumns;
struct RDI_U32_SourceLineMaps              { RDI_U32 v; } RDI_U32_SourceLineMaps;
struct RDI_U32_SourceLineMapNumbers        { RDI_U32 v; } RDI_U32_SourceLineMapNumbers;
struct RDI_U32_SourceLineMapRanges         { RDI_U32 v; } RDI_U32_SourceLineMapRanges;
struct RDI_U32_SourceLineMapVOffs          { RDI_U32 v; } RDI_U32_SourceLineMapVOffs;
struct RDI_U32_Units                       { RDI_U32 v; } RDI_U32_Units;
struct RDI_U32_TypeNodes                   { RDI_U32 v; } RDI_U32_TypeNodes;
struct RDI_U32_UDTs                        { RDI_U32 v; } RDI_U32_UDTs;
struct RDI_U32_Members                     { RDI_U32 v; } RDI_U32_Members;
struct RDI_U32_EnumMembers                 { RDI_U32 v; } RDI_U32_EnumMembers;
struct RDI_U32_GlobalVariables             { RDI_U32 v; } RDI_U32_GlobalVariables;
struct RDI_U32_ThreadVariables             { RDI_U32 v; } RDI_U32_ThreadVariables;
struct RDI_U32_Procedures                  { RDI_U32 v; } RDI_U32_Procedures;
struct RDI_U32_Scopes                      { RDI_U32 v; } RDI_U32_Scopes;
struct RDI_U32_ScopeVOffData               { RDI_U32 v; } RDI_U32_ScopeVOffData;
struct RDI_U32_InlineSites                 { RDI_U32 v; } RDI_U32_InlineSites;
struct RDI_U32_Locals                      { RDI_U32 v; } RDI_U32_Locals;
struct RDI_U32_LocationBlocks              { RDI_U32 v; } RDI_U32_LocationBlocks;
struct RDI_U32_LocationData                { RDI_U32 v; } RDI_U32_LocationData;
struct RDI_U32_NameMaps                    { RDI_U32 v; } RDI_U32_NameMaps;
struct RDI_U32_NameMapBuckets              { RDI_U32 v; } RDI_U32_NameMapBuckets;
struct RDI_U32_NameMapNodes                { RDI_U32 v; } RDI_U32_NameMapNodes;
#else
struct RDI_U32_Table { RDI_U32 v; } RDI_U32_Table;
struct RDI_U64_Table { RDI_U64 v; } RDI_U64_Table;
