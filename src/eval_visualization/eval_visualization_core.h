...
enum EV_ViewRuleInfoFlags : uint // NOTE(rjf): see @view_rule_info
{
...
EV_Key ev_key_make(ulong parent_hash, ulong child_id);
EV_Key ev_key_zero();
EV_Key ev_key_root();
B32 ev_key_match(EV_Key a, EV_Key b);
ulong ev_hash_from_seed_string(ulong seed, String8 string);
ulong ev_hash_from_key(EV_Key key);
...
ulong ev_depth_from_block(EV_Block *block);

////////////////////////////////
//~ rjf: Block Coordinate Spaces

EV_BlockRangeList ev_block_range_list_from_tree(Arena *arena, EV_BlockTree *block_tree);
EV_BlockRange ev_block_range_from_num(EV_BlockRangeList *block_ranges, ulong num);
EV_Key ev_key_from_num(EV_BlockRangeList *block_ranges, ulong num);
ulong    ev_num_from_key(EV_BlockRangeList *block_ranges, EV_Key key);
...
String8 ev_string_from_hresult_facility_code(uint code);
String8 ev_string_from_hresult_code(uint code);
String8 ev_string_from_simple_typed_eval(Arena *arena, EV_StringFlags flags, uint radix, uint min_digits, E_Eval eval);
