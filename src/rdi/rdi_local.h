...
static String8 str8_from_rdi_string_idx(RDI_Parsed *rdi, U32 idx);

////////////////////////////////
//~ rjf: String <=> Enum

static String8 rdi_string_from_data_section_kind(Arena *arena, RDI_SectionKind v);
static String8 rdi_string_from_arch             (Arena *arena, RDI_Arch        v);
static String8 rdi_string_from_language         (Arena *arena, RDI_Language    v);
static String8 rdi_string_from_local_kind       (Arena *arena, RDI_LocalKind   v);
#if 0 // TODO(rjf): conflicts with RDI...
static String8 rdi_string_from_type_kind        (Arena *arena, RDI_TypeKind    v);
#endif
static String8 rdi_string_from_member_kind      (Arena *arena, RDI_MemberKind  v);
static String8 rdi_string_from_name_map_kind(RDI_NameMapKind kind);

static String8 rdi_string_from_binary_section_flags(Arena *arena, RDI_BinarySectionFlags flags);
static String8 rdi_string_from_type_modifier       (Arena *arena, RDI_TypeModifierFlags  flags);
static String8 rdi_string_from_udt_flags           (Arena *arena, RDI_UDTFlags           flags);
static String8 rdi_string_from_link_flags          (Arena *arena, RDI_LinkFlags          flags);
static String8 rdi_string_from_bytecode(Arena *arena, RDI_Arch arch, String8 bc);
static String8List rdi_strings_from_locations(Arena *arena, RDI_Parsed *rdi, RDI_Arch arch, Rng1U64 location_block_range);

////////////////////////////////
//~ rjf: RDI Dumping

static String8List rdi_dump_list_from_parsed(Arena *arena, RDI_Parsed *rdi, RDI_DumpSubsetFlags flags);
