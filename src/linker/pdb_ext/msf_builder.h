...
internal ulong              msf_get_save_size(MSF_Context *msf);
internal String8List      msf_get_page_data_nodes(Arena *arena, MSF_Context *msf);
internal B32              msf_save(MSF_Context *msf, void *buffer, ulong buffer_size);
...
internal String8  msf_stream_read_block(Arena *arena, MSF_Context *msf, MSF_StreamNumber sn, ulong block_size);
...
internal byte       msf_stream_read_u8(MSF_Context *msf, MSF_StreamNumber sn);
internal ushort      msf_stream_read_u16(MSF_Context *msf, MSF_StreamNumber sn);
internal uint      msf_stream_read_u32(MSF_Context *msf, MSF_StreamNumber sn);
internal ulong      msf_stream_read_u64(MSF_Context *msf, MSF_StreamNumber sn);
...
internal B32 msf_stream_write_u8(MSF_Context *msf, MSF_StreamNumber sn, byte value);
internal B32 msf_stream_write_u16(MSF_Context *msf, MSF_StreamNumber sn, ushort value);
internal B32 msf_stream_write_u32(MSF_Context *msf, MSF_StreamNumber sn, uint value);
internal B32 msf_stream_write_u64(MSF_Context *msf, MSF_StreamNumber sn, ulong value);
...
internal MSF_UInt       msf_count_pages(MSF_UInt page_size, ulong data_size);
