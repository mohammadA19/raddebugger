...
uint32                gsi_hash(PDB_GsiContext* gsi, String8 input);
...
CV_SymbolNode *  psi_push(PDB_PsiContext* psi, CV_Pub32Flags flags, uint32 offset, uint16 isect, String8 name);
...
PDB_HashTableParseError pdb_hash_table_from_data(PDB_HashTable* ht, String8 data, B32 has_local_data, PDB_HashTableUnpackFunc* unpack_func, void* unpack_ud, uint64* read_bytes_out);
...
uint32                     pdb_hash_table_hash(String8 key);
...
PDB_HashTableParseError pdb_hash_adj_hash_table_from_data(PDB_HashTable* ht, String8 data, PDB_StringTable* strtab, uint64* read_bytes_out);
PDB_HashTableParseError pdb_src_header_block_ht_from_data(PDB_HashTable* ht, String8 data, PDB_StringTable* strtab, uint64* read_bytes_out);
PDB_HashTableParseError pdb_named_stream_ht_from_data(PDB_HashTable* ht, String8 data, uint64* read_bytes_out);
...
uint32                      pdb_strtab_hash(PDB_StringTable* strtab, String8 string);
