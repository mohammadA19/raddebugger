...
{
  LNK_InputObj **result = /* no zero */ push_array(arena, LNK_InputObj *, list.count);
  U64 i = 0;
...
{
  LNK_InputImportNode **result = /* no zero */ push_array(arena, LNK_InputImportNode *, list.count);
  U64 idx = 0;
