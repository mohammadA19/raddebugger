...
internal U64
cv_compute_leaf_record_size(StringView data, U64 align)
{
    U64 size = 0;
...
internal U64
cv_serialize_leaf_to_buffer(U8 *buffer, U64 buffer_cursor, U64 buffer_size, CV_LeafKind kind, StringView data, U64 align)
{
...
internal StringView
cv_serialize_raw_leaf(Arena *arena, CV_LeafKind kind, StringView data, U64 align)
{
    ...
    StringView  raw_leaf    = str8(buffer, size);
    return raw_leaf;
}
...
internal U64
cv_deserial_leaf(StringView raw_data, U64 off, U64 align, CV_Leaf *leaf_out)
{
...
internal StringView
cv_make_obj_name(Arena *arena, StringView obj_path, U32 sig)
{
    ProfBeginFunction();
    Temp scratch = scratch_begin(&arena, 1);
...
internal CV_Symbol
cv_make_proc_ref(Arena *arena, CV_ModIndex imod, U32 stream_offset, StringView name, B32 is_local)
{
...
internal CV_Symbol
cv_make_pub32(Arena *arena, CV_Pub32Flags flags, U32 off, U16 isect, StringView name)
{
...
cv_string_table_from_debug_s(CV_DebugS debug_s)
{
    ...
    StringView string_data = str8_zero();
...
cv_file_chksms_from_debug_s(CV_DebugS debug_s)
{
    ...
    StringView file_chksms = str8_zero();
    if (data_list.node_count > 0) {
...
internal CV_DebugT
cv_debug_t_from_data(Arena *arena, StringView data, U64 align)
{
    String8Array arr = {0};
    arr.count        = 1;
    arr.v            = &data;
...
cv_debug_t_get_leaf(CV_DebugT debug_t, U64 leaf_idx)
{
    ...
    StringView data = str8(ptr, max_U64);
...
cv_debug_t_get_raw_leaf(CV_DebugT debug_t, U64 leaf_idx)
{
    ...
    StringView raw_leaf = str8(leaf_ptr, total_size);
    return raw_leaf;
}
...
internal void
cv_parse_symbol_sub_section_capped(Arena *arena, CV_SymbolList *list, U64 offset_base, StringView data, U64 align, U64 cap)
{
    U64 count = 0;
...
internal void
cv_parse_symbol_sub_section(Arena *arena, CV_SymbolList *list, U64 offset_base, StringView data, U64 align)
{
...
internal void
cv_c13_patch_string_offsets_in_checksum_list(CV_ChecksumList checksum_list, StringView string_data, U64 string_data_base_offset, CV_StringHashTable string_ht)
{
...
cv_c13_line_array_from_data(Arena *arena, StringView c13_data, U64 sec_base, CV_C13LinesHeader parsed_lines)
{
    CV_LineArray result;
