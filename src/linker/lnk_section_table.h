...
internal LNK_SectionContrib *       lnk_section_contrib_chunk_push(LNK_SectionContribChunk *chunk, uint64 count);
internal LNK_SectionContrib *       lnk_section_contrib_chunk_push_atomic(LNK_SectionContribChunk *chunk, uint64 count);
internal LNK_SectionContribChunk *  lnk_section_contrib_chunk_list_push_chunk(Arena *arena, LNK_SectionContribChunkList *list, uint64 cap, String8 sort_idx);
...
internal void lnk_finalize_section_layout     (LNK_Section *sect, uint64 file_align, uint64 pad_size);
internal void lnk_assign_section_index        (LNK_Section *sect, uint64 sect_idx);
internal void lnk_assign_section_virtual_space(LNK_Section *sect, uint64 sect_align, uint64 *voff_cursor);
internal void lnk_assign_section_file_space   (LNK_Section *sect, uint64 *foff_cursor);

// --- Section Contribution ----------------------------------------------------

internal uint64 lnk_size_from_section_contrib(LNK_SectionContrib *sc);
internal uint64 lnk_voff_from_section_contrib(COFF_SectionHeader **image_section_table, LNK_SectionContrib *sc);
internal uint64 lnk_foff_from_section_contrib(COFF_SectionHeader **image_section_table, LNK_SectionContrib *sc);
internal uint64 lnk_fopl_from_section_contrib(COFF_SectionHeader **image_section_table, LNK_SectionContrib *sc);
...
internal uint64                  lnk_get_section_contrib_size(LNK_Section *sect);
internal uint64                  lnk_get_first_section_contrib_voff(COFF_SectionHeader **image_section_table, LNK_Section *sect);
