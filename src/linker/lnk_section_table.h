...
LNK_Chunk *   lnk_section_push_chunk_raw(LNK_Section *sect, LNK_Chunk *parent, void *data_ptr, U64 data_size, String8 sort_index);
...
LNK_Section *       lnk_section_table_search_id(LNK_SectionTable *st, U64 id);
