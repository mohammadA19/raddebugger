...
LNK_Reloc * lnk_section_push_reloc_undefined(LNK_Section* sect, LNK_Chunk* chunk, LNK_RelocType type, uint64 apply_off, String8 undefined_symbol_name, LNK_SymbolScopeFlags scope_flags);
...
String8 lnk_make_section_sort_index(Arena* arena, String8 name, COFF_SectionFlags flags, uint64 section_index);

LNK_Chunk *   lnk_section_push_chunk_raw(LNK_Section* sect, LNK_Chunk* parent, void* data_ptr, uint64 data_size, String8 sort_index);
LNK_Chunk *   lnk_section_push_chunk_data(LNK_Section* sect, LNK_Chunk* parent, String8 data, String8 sort_index);
LNK_Chunk *   lnk_section_push_chunk_u32(LNK_Section* sect, LNK_Chunk* parent, uint32 value, String8 sort_index);
LNK_Chunk *   lnk_section_push_chunk_u64(LNK_Section* sect, LNK_Chunk* parent, uint32 value, String8 sort_index);
LNK_Chunk *   lnk_section_push_chunk_bss(LNK_Section* sect, LNK_Chunk* parent, uint64 size, String8 sort_index);
