...
static void lnk_init_error_handler(void);
static void lnk_errorfv(LNK_ErrorCode code, char *fmt, va_list args);
static void lnk_error(LNK_ErrorCode code, char *fmt, ...);
static void lnk_error_with_loc(LNK_ErrorCode code, String8 obj_path, String8 lib_path, char *fmt, ...);
static void lnk_supplement_error(char *fmt, ...);
static void lnk_supplement_error_list(String8List list);
static void lnk_suppress_error(LNK_ErrorCode code);
...
static LNK_ErrorCodeStatus lnk_get_error_code_status(LNK_ErrorCode code);

static void lnk_internal_error(LNK_InternalError code, char *file, int line, char *fmt, ...);
