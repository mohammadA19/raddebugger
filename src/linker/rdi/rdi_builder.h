...
void            rdib_path_tree_insert  (Arena* arena, RDIB_PathTree* tree, StringView path, RDIB_SourceFile* src_file);
uint32             rdib_idx_from_path_tree(RDIB_PathTree* tree, StringView path);
