...
internal void
rdib_string_map_insert_item(Arena *arena, RDIB_CollectStringsTask *task, U64 task_id, StringView string, void *value)
{
...
internal void
rdib_string_map_insert_string_table_item(Arena *arena, RDIB_CollectStringsTask *task, U64 task_id, StringView string)
{
    rdib_string_map_insert_item(arena, task, task_id, string, 0);
}

internal void
rdib_string_map_insert_name_map_item(Arena *arena, RDIB_CollectStringsTask *task, U64 task_id, StringView string, VoidNode *node)
{
