...
internal RDIB_LocationNode *
rdib_push_location_addr_reg_off(Arena *arena, RDIB_LocationList *list, RDI_Arch arch, RDI_RegCode reg_code, u32 reg_byte_size, u32 reg_byte_pos, i64 offset, b32 is_reference, Rng1U64List ranges)
{
  RDIB_Location loc;
