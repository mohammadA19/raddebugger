...
int u64_compar_inv(const void *raw_a, const void *raw_b)
{
  U64 a = *(const U64*)raw_a;
  U64 b = *(const U64*)raw_b;
  int result = a < b  ? +1 : a > b  ? -1 : 0;
...
int u16_compar_is_before(void *raw_a, void *raw_b)
{
  U16 *a = (U16 *)raw_a;
  U16 *b = (U16 *)raw_b;
  int is_before = *a < *b;
...
int u32_compar_is_before(void *raw_a, void *raw_b)
{
  U32 *a = (U32 *)raw_a;
  U32 *b = (U32 *)raw_b;
  int is_before = *a < *b;
...
int u64_compar_is_before(void *raw_a, void *raw_b)
{
  U64 *a = (U64 *)raw_a;
  U64 *b = (U64 *)raw_b;
  int is_before = *a < *b;
...
int pair_u32_is_before(void *raw_a, void *raw_b)
{
  PairU32 *a = raw_a;
  PairU32 *b = raw_b;
  return a->v1 < b->v1;
...
int pair_u32_compar_v0(const void *raw_a, const void *raw_b)
{
...
int pair_u64_compar_v0(const void *raw_a, const void *raw_b)
{
...
int pair_u64_compar_v1(const void *raw_a, const void *raw_b)
{
  const PairU64 *a = raw_a;
  const PairU64 *b = raw_b;
