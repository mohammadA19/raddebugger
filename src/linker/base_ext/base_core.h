...
static U16 safe_cast_u16x(U64 x);

////////////////////////////////

static U64 u128_mod64(U128 a, U64 b);

////////////////////////////////

static Version make_version(U64 major, U64 minor);
static int     version_compar(Version a, Version b);

////////////////////////////////

static ISectOff isect_off(U32 isect, U32 off);

////////////////////////////////

static int u16_compar(const void *raw_a, const void *raw_b);
static int u32_compar(const void *raw_a, const void *raw_b);
static int u64_compar(const void *raw_a, const void *raw_b);

static int u8_is_before(void *raw_a, void *raw_b);
static int u16_is_before(void *raw_a, void *raw_b);
static int u32_is_before(void *raw_a, void *raw_b);
static int u64_is_before(void *raw_a, void *raw_b);

static int pair_u32_is_before_v0(void *raw_a, void *raw_b);
static int pair_u32_is_before_v1(void *raw_a, void *raw_b);
static int pair_u64_is_before_v0(void *raw_a, void *raw_b);
static int pair_u64_is_before_v1(void *raw_a, void *raw_b);

////////////////////////////////

static void str8_list_concat_in_place_array(String8List *list, String8List *arr, U64 count);
