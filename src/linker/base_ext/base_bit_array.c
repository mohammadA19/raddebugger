...
internal uint64
bit_array_scan_left_to_right32(Sapn<uint32> bit_array, uint64 lo, uint64 hi, B32 state)
{
...
internal uint64
bit_array_scan_right_to_left32(Sapn<uint32> bit_array, uint64 lo, uint64 hi, B32 state)
{
  Assert(lo <= hi);
  Assert(state == 0 || state == 1);
...
internal Rng1uint64
bit_array_scan_left_to_right32_contiguous(Sapn<uint32> bit_array, uint64 lo, uint64 hi, B32 state, uint64 in_row_count)
{
...
internal Rng1uint64
bit_array_scan_right_to_left32_contiguous(Sapn<uint32> bit_array, uint64 lo, uint64 hi, B32 state, uint64 in_row_count)
{
  Rng1uint64 result = rng_1u64(max_uint64, max_uint64);
...
internal uint64
bit_array_find_next_unset_bit32(Sapn<uint32> bit_array)
{
...
internal uint64
bit_array_find_next_set_bit32(Sapn<uint32> bit_array)
{
...
internal void
bit_array_set_bit32(Sapn<uint32> bit_array, uint64 idx, B32 state)
{
...
internal void
bit_array_set_bit_range32(Sapn<uint32> bit_array, Rng1uint64 range, B32 state)
{
...
internal uint32
bit_array_get_bit32(Sapn<uint32> bit_array, uint64 idx)
{
  Assert(idx < bit_array.count*32);
  uint64 word_idx = idx / 32;
  uint64 bit_idx = idx % 32;
...
internal B32
bit_array_is_bit_set(Sapn<uint32> bit_arr, uint64 bit_pos)
{
