...
#define Case(str, flag) if(str8_match(string, (str), StringMatchFlags.CaseInsensitive)) {result->flags |= P2R_ConvertFlag_##flag;}
        FlagNameMapXList;
#undef Case
      }
    }
    ...
    if(in->comp_units != 0)
  {
      ...
      for(U64 comp_unit_idx = 0; comp_unit_idx < in->comp_units->count; comp_unit_idx += 1)
    {
      ...
      if(str8_match(obj_name, ("* Linker *"), 0) ||
         str8_match(obj_name, ("Import:"), StringMatchFlags.RightSideSloppy))
      {
