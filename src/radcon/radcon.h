...
static RC_Context  rc_context_from_cmd_line(Arena *arena, CmdLine *cmdl);
static String8List rc_run(Arena *arena, RC_Context *rc);
static String8     rc_rdi_from_cmd_line(Arena *arena, CmdLine *cmdl);
static void        rc_main(CmdLine *cmdl);
