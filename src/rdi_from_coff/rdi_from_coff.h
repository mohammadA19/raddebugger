...
internal RDIM_BinarySectionList c2r_rdi_binary_sections_from_coff_sections(Arena *arena, string image_data, string string_table, U64 sectab_count, COFF_SectionHeader *sectab);
