...
void lnx_date_time_from_tm(DateTime* out, struct tm* in, uint32 msec);
...
StringView lnx_string_from_signal(int signum);
StringView lnx_string_from_errno(int error_number);
