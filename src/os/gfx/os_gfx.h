...
internal uint os_codepoint_from_modifiers_and_key(OS_Modifiers flags, OS_Key key);
...
internal B32  os_text(OS_EventList *events, OS_Handle window, uint character);
