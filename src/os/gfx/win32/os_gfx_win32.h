...
public static OS_W32_GfxState *os_w32_gfx_state = 0;
public static OS_EventList os_w32_event_list = {0};
public static Arena *os_w32_event_arena = 0;
public static B32 os_w32_resizing = 0;
public static B32 os_w32_new_window_custom_border = 0;
