...
static Rng2F32 os_w32_rng2f32_from_rect(RECT rect);

////////////////////////////////
//~ rjf: Windows

static OS_Handle       os_w32_handle_from_window(OS_W32_Window *window);
static OS_W32_Window * os_w32_window_from_handle(OS_Handle window);
static OS_W32_Window * os_w32_window_from_hwnd(HWND hwnd);
static HWND            os_w32_hwnd_from_window(OS_W32_Window *window);
static OS_W32_Window * os_w32_window_alloc(void);
static void            os_w32_window_release(OS_W32_Window *window);
static OS_Event *      os_w32_push_event(OS_EventKind kind, OS_W32_Window *window);
static OS_Key          os_w32_os_key_from_vkey(WPARAM vkey);
static WPARAM          os_w32_vkey_from_os_key(OS_Key key);
static LRESULT         os_w32_wnd_proc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam);

////////////////////////////////
//~ rjf: Monitors

static BOOL os_w32_monitor_gather_enum_proc(HMONITOR monitor, HDC hdc, LPRECT rect, LPARAM bundle_ptr);
