...
public static w32_GetDpiForWindow_Type *w32_GetDpiForWindow_func = 0;
public static w32_GetDpiForMonitor_Type *w32_GetDpiForMonitor_func = 0;
public static w32_GetSystemMetricsForDpi_Type *w32_GetSystemMetricsForDpi_func = 0;
