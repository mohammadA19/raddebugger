...
internal String8 rd_string_from_flags(Arena *arena, String8List list, uint64 remaining_flags);

internal void rd_format_preamble(Arena *arena, String8List *out, String8 indent, String8 input_path, String8 raw_data);

// Markers

internal RD_MarkerArray * rd_section_markers_from_coff_symbol_table(Arena *arena, String8 string_table, uint64 section_count, COFF_Symbol32Array symbols);

// Sections

internal RD_SectionArray rd_sections_from_coff_section_table(Arena *arnea, String8 raw_image, uint64 string_table_off, uint64 section_count, COFF_SectionHeader *sections);

// Disasm

internal RD_DisasmResult rd_disasm_next_instruction(Arena *arena, Arch arch, uint64 addr, String8 raw_code);
internal void            rd_print_disasm           (Arena *arena, String8List *out, String8 indent, Arch arch, uint64 image_base, uint64 sect_off, uint64 marker_count, RD_Marker *markers, String8 raw_code);

// Raw Data

internal String8 rd_format_hex_array(Arena *arena, uint8 *ptr, uint64 size);
internal void    rd_print_raw_data  (Arena *arena, String8List *out, String8 indent, uint64 bytes_per_row, uint64 marker_count, RD_Marker *markers, String8 raw_data);
...
internal uint64  cv_print_leaf           (Arena *arena, String8List *out, String8 indent, CV_TypeIndex min_itype, CV_LeafKind kind, String8 raw_leaf);
...
internal void pe_print_data_directory_ranges(Arena *arena, String8List *out, String8 indent, uint64 count, PE_DataDirectory *dirs);
...
internal void pe_print_static_import_table  (Arena *arena, String8List *out, String8 indent, uint64 image_base, PE_ParsedStaticImportTable imptab);
internal void pe_print_delay_import_table   (Arena *arena, String8List *out, String8 indent, uint64 image_base, PE_ParsedDelayImportTable imptab);
internal void pe_print_resources            (Arena *arena, String8List *out, String8 indent, PE_ResourceDir *root);
internal void pe_print_exceptions_x8664     (Arena *arena, String8List *out, String8 indent, uint64 section_count, COFF_SectionHeader *sections, String8 raw_data, Rng1uint64 except_frange, RDI_Parsed *rdi);
internal void pe_print_exceptions           (Arena *arena, String8List *out, String8 indent, COFF_MachineType machine, uint64 section_count, COFF_SectionHeader *sections, String8 raw_data, Rng1uint64 except_frange, RDI_Parsed *rdi);
internal void pe_print_base_relocs          (Arena *arena, String8List *out, String8 indent, COFF_MachineType machine, uint64 image_base, uint64 section_count, COFF_SectionHeader *sections, String8 raw_data, Rng1uint64 base_reloc_franges, RDI_Parsed *rdi);
