...
internal String8
pe_make_debug_directory_pdb_obj(Arena *arena, COFF_MachineType machine, Guid guid, uint32 age, COFF_TimeStamp time_stamp, String8 path)
{
...
internal String8
pe_make_debug_directory_rdi_obj(Arena *arena, COFF_MachineType machine, Guid guid, uint32 age, COFF_TimeStamp time_stamp, String8 path)
{
  COFF_ObjWriter *obj_writer = coff_obj_writer_alloc(COFF_TimeStamp_Max, machine);
