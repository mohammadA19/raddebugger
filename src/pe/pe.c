...
internal B32
pe_check_magic(StringView data)
{
    B32 is_pe = 0;
...
pe_data_directory_from_idx(StringView file_data, PE_BinInfo pe, PE_DataDirectoryIndex dir_idx)
{
...
pe_debug_info_list_from_raw_debug_dir(Arena *arena, StringView raw_image, StringView raw_debug_dir)
{
...
internal U64
pe_pdata_off_from_voff__binary_search_x8664(StringView raw_pdata, U64 voff)
{
    U64 result = 0;
...
internal U64
pe_foff_from_voff(StringView data, PE_BinInfo *bin, U64 voff)
{
    U64                 foff              = 0;
    StringView             raw_section_table = str8_substr(data, bin.section_table_range);
...
internal Rng1U64
pe_tls_rng_from_bin_base_vaddr(StringView data, PE_BinInfo *bin, U64 base_vaddr)
{
                                                        ...
                                                        U64                *import_count_out)
{
    ...
    StringView entries = str8_substr(raw_data, rng_1u64(name_table_foff, raw_data.size));
    if (is_pe32) {
...
internal U64 *
pe_array_from_null_term_addr(Arena *arena, B32 is_pe32, StringView raw_data, Rng1U64 range, U64 *count_out)
{
    U64 *result = 0;
    *count_out = 0;
...
pe_exports_from_data(Arena *arena, U64 section_count, COFF_SectionHeader *sections, StringView raw_data, Rng1U64 dir_file_range, Rng1U64 dir_virt_range)
{
    Temp scratch = scratch_begin(&arena, 1);
    ...
    if (header) {
        ...
        if (name_table && export_table && ordinal_table) {
            ...
            for (U64 i = 0; i < header.name_pointer_table_count; ++i) {
                ...
                StringView forwarder = str8_zero();
                {
...
internal PE_ResourceNode *
pe_resource_dir_push_entry_node(Arena *arena, PE_ResourceDir *dir, COFF_ResourceID id, COFF_ResourceID type, U32 data_version, U32 version, COFF_ResourceMemoryFlags memory_flags, StringView data)
{
...
pe_resource_dir_push_entry(Arena *arena, PE_ResourceDir *dir, COFF_ResourceID id, COFF_ResourceID type, U32 data_version, U32 version, COFF_ResourceMemoryFlags memory_flags, StringView data)
{
...
internal StringView
pe_make_manifest_resource(Arena *arena, U32 resource_id, StringView manifest_data)
{
...
internal StringView
pe_make_debug_header_pdb70(Arena *arena, Guid guid, U32 age, StringView pdb_path)
{
    Temp scratch = scratch_begin(&arena, 1);
...
internal void
pe_pdata_sort(COFF_MachineType machine, StringView raw_pdata)
{
    ProfBeginFunction();
    switch (machine) {
    case COFF_MachineType_Unknown: break;
