...
uint32 dim_1u32(Rng1U32 r)                                {uint32 c = r.max-r.min; return c;}
...
int32 dim_1s32(Rng1S32 r)                                {int32 c = r.max-r.min; return c;}
...
uint64 dim_1u64(Rng1U64 r)                                {uint64 c = r.max-r.min; return c;}
...
int64 dim_1s64(Rng1S64 r)                                {int64 c = r.max-r.min; return c;}
...
Vec2S16 dim_2s16(Rng2S16 r)                            {Vec2S16 dim = {(int16)(r.max.x-r.min.x), (int16)(r.max.y-r.min.y)}; return dim;}
...
Vec2S32 dim_2s32(Rng2S32 r)                            {Vec2S32 dim = {r.max.x-r.min.x, r.max.y-r.min.y}; return dim;}
...
Vec2S64 dim_2s64(Rng2S64 r)                            {Vec2S64 dim = {r.max.x-r.min.x, r.max.y-r.min.y}; return dim;}
