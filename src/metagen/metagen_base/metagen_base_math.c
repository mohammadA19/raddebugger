...
uint dim_1u32(Rng1U32 r)                                {uint c = r.max-r.min; return c;}
...
int dim_1s32(Rng1S32 r)                                {int c = r.max-r.min; return c;}
...
ulong dim_1u64(Rng1U64 r)                                {ulong c = r.max-r.min; return c;}
...
long dim_1s64(Rng1S64 r)                                {long c = r.max-r.min; return c;}
