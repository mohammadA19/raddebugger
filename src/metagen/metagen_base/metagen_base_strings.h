...
void * str8_deserial_get_raw_ptr(String8 string, uint64 off, uint64 size);internal uint64 str8_deserial_read_cstr(String8 string, uint64 off, String8* cstr_out);
