...
//- rjf: integer -> string
internal String8 str8_from_memory_size(Arena *arena, ulong z);
...
internal void * str8_deserial_get_raw_ptr(String8 string, ulong off, ulong size);internal ulong str8_deserial_read_cstr(String8 string, ulong off, String8 *cstr_out);
