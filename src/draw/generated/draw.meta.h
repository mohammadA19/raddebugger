...
DR_Tex2DSampleKindNode :: struct {DR_Tex2DSampleKindNode *next; R_Tex2DSampleKind v;};
DR_XForm2DNode :: struct {DR_XForm2DNode *next; Mat3x3F32 v;};
DR_ClipNode :: struct {DR_ClipNode *next; Rng2F32 v;};
DR_TransparencyNode :: struct {DR_TransparencyNode *next; F32 v;};
