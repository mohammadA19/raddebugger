...
@(rodata) global DR_Tex2DSampleKindNode dr_nil_tex2d_sample_kind = {0, R_Tex2DSampleKind_Nearest};
@(rodata) global DR_XForm2DNode dr_nil_xform2d = {0, {1, 0, 0, 0, 1, 0, 0, 0, 1}};
@(rodata) global DR_ClipNode dr_nil_clip = {0, {0}};
@(rodata) global DR_TransparencyNode dr_nil_transparency = {0, 0};
