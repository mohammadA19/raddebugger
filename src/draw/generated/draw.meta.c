...
float                        dr_push_transparency(float v) {DR_StackPushImpl(Transparency, transparency, float, v);}
...
float                        dr_pop_transparency() {DR_StackPopImpl(Transparency, transparency, float);}
...
float                        dr_top_transparency() {DR_StackTopImpl(Transparency, transparency, float);}
