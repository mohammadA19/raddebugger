...
thread_local static UI_State *ui_state = 0;
...
static U64 ui_string_hover_begin_time_us()
{
...
static void ui_box_equip_display_fstrs(UI_Box *box, DR_FStrList *strings)
{
  box->flags |= UI_BoxFlag_HasDisplayString;
