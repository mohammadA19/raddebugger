...
struct UI_MinWidthNode{UI_MinWidthNode *next; F32 v;};
struct UI_MinHeightNode{UI_MinHeightNode *next; F32 v;};
...
struct UI_OmitFlagsNode{UI_OmitFlagsNode *next; UI_BoxFlags v;};
...
struct UI_TagNode{UI_TagNode *next; String8 v;};
struct UI_BackgroundColorNode{UI_BackgroundColorNode *next; Vec4F32 v;};
struct UI_TextColorNode{UI_TextColorNode *next; Vec4F32 v;};
struct UI_BorderColorNode{UI_BorderColorNode *next; Vec4F32 v;};
