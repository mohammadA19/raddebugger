...
internal void ui_label_multiline(F32 max, string string);
...
internal UI_Signal ui_hover_label(string string);
internal UI_Signal ui_hover_labelf(char *fmt, ...);
internal UI_Signal ui_line_edit(TxtPt *cursor, TxtPt *mark, U8 *edit_buffer, U64 edit_buffer_size, U64 *edit_string_size_out, string pre_edit_value, string string);
internal UI_Signal ui_line_editf(TxtPt *cursor, TxtPt *mark, U8 *edit_buffer, U64 edit_buffer_size, U64 *edit_string_size_out, string pre_edit_value, char *fmt, ...);

////////////////////////////////
//~ rjf: Images

internal UI_Signal ui_image(R_Handle texture, R_Tex2DSampleKind sample_kind, Rng2F32 region, Vec4F32 tint, F32 blur, string string);
...
internal UI_Signal ui_expander(B32 is_expanded, string string);
internal UI_Signal ui_expanderf(B32 is_expanded, char *fmt, ...);
internal UI_Signal ui_sort_header(B32 sorting, B32 ascending, string string);
...
internal UI_Signal ui_sat_val_picker(F32 hue, F32 *out_sat, F32 *out_val, string string);
internal UI_Signal ui_sat_val_pickerf(F32 hue, F32 *out_sat, F32 *out_val, char *fmt, ...);

//- rjf: hue picker
internal UI_Signal ui_hue_picker(F32 *out_hue, F32 sat, F32 val, string string);
internal UI_Signal ui_hue_pickerf(F32 *out_hue, F32 sat, F32 val, char *fmt, ...);

//- rjf: alpha picker
internal UI_Signal ui_alpha_picker(F32 *out_alpha, string string);
...
internal UI_Box *ui_pane_begin(Rng2F32 rect, string string);
...
internal void ui_table_begin(U64 column_pct_count, F32 **column_pcts, string string);
internal void ui_table_beginf(U64 column_pct_count, F32 **column_pcts, char *fmt, ...);
internal void ui_table_end(void);
internal UI_Box *  ui_named_table_vector_begin(string string);
