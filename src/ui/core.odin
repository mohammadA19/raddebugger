...
UI_IconInfo :: struct {
  icon_font: FNT_Tag,
  icon_kind_text_map: [UI_IconKind_COUNT]String8,
}
...
UI_ThemePattern :: struct {
  tags: String8Array,
  linear: Vec4F32,
}

UI_Theme :: struct {
  patterns: ^UI_ThemePattern,
  patterns_count: u64,
}
...
UI_AnimationInfo :: struct {
  hot_animation_rate: f32,
  active_animation_rate: f32,
  focus_animation_rate: f32,
  tooltip_animation_rate: f32,
  menu_animation_rate: f32,
  scroll_animation_rate: f32,
}
////////////////////////////////
...
UI_Box :: struct {
  ...
  fixed_size: Vec2F32,
  min_size: Vec2F32,
  pref_size: [Axis2_COUNT]UI_Size,
  child_layout_axis: Axis2,
  hover_cursor: OS_Cursor,
  fastpath_codepoint: u64,
  group_key: UI_Key,
  draw_bucket: ^DR_Bucket,
  custom_draw: ^UI_BoxCustomDrawFunctionType,
  custom_draw_user_data: ^void,
  background_color: Vec4F32,
  text_color: Vec4F32,
  ...
  display_fstrs: DR_FStrList,
  display_fruns: DR_FRunList,
  rect: Rng2F32,
  ...
  //- rjf: persistent data
  first_touched_build_index: u64,
  last_touched_build_index: u64,
  first_disabled_build_index: u64,
  hot_t: f32,
  active_t: f32,
  disabled_t: f32,
  focus_hot_t: f32,
  focus_active_t: f32,
  focus_active_disabled_t: f32,
  view_off: Vec2F32,
...
ui_pressed :: proc (s: UI_Signal) -> bool        { return s.f & UI_SignalFlag_Pressed }
ui_clicked :: proc (s: UI_Signal) -> bool        { return s.f & UI_SignalFlag_Clicked }
ui_released :: proc (s: UI_Signal) -> bool       { return s.f & UI_SignalFlag_Released }
ui_double_clicked :: proc (s: UI_Signal) -> bool { return s.f & UI_SignalFlag_DoubleClicked }
ui_triple_clicked :: proc (s: UI_Signal) -> bool { return s.f & UI_SignalFlag_TripleClicked }
ui_middle_clicked :: proc (s: UI_Signal) -> bool { return s.f & UI_SignalFlag_MiddleClicked }
ui_right_clicked :: proc (s: UI_Signal) -> bool  { return s.f & UI_SignalFlag_RightClicked }
ui_dragging :: proc (s: UI_Signal) -> bool       { return s.f & UI_SignalFlag_Dragging }
ui_hovering :: proc (s: UI_Signal) -> bool       { return s.f & UI_SignalFlag_Hovering }
ui_mouse_over :: proc (s: UI_Signal) -> bool     { return s.f & UI_SignalFlag_MouseOver }
ui_committed :: proc (s: UI_Signal) -> bool      { return s.f & UI_SignalFlag_Commit }
...
UI_AnimNode :: struct {
  slot_next: ^UI_AnimNode,
  slot_prev: ^UI_AnimNode,
  lru_next: ^UI_AnimNode,
  lru_prev: ^UI_AnimNode,
  first_touched_build_index: u64,
  last_touched_build_index: u64,
  key: UI_Key,
...
UI_TagsCacheNode :: struct {
  next: ^UI_TagsCacheNode,
  key: UI_Key,
  tags: String8Array,
}

UI_TagsCacheSlot :: struct {
  first: ^UI_TagsCacheNode,
  last: ^UI_TagsCacheNode,
}

UI_TagsKeyStackNode :: struct {
  next: ^UI_TagsKeyStackNode,
  key: UI_Key,
}

//- rjf: cache for mapping 64-bit key -> theme pattern

UI_ThemePatternCacheNode :: struct {
  slot_next: ^UI_ThemePatternCacheNode,
  slot_prev: ^UI_ThemePatternCacheNode,
  lru_next: ^UI_ThemePatternCacheNode,
  lru_prev: ^UI_ThemePatternCacheNode,
  last_build_index_accessed: u64,
  key: UI_Key,
  target_rgba: Vec4F32,
  current_rgba: Vec4F32,
}

UI_ThemePatternCacheSlot :: struct {
  first: ^UI_ThemePatternCacheNode,
  last: ^UI_ThemePatternCacheNode,
}
...
UI_State :: struct {
  ...
  box_table_size: u64,
  box_table: ^UI_BoxHashSlot,
  
  //- rjf: anim cache
  free_anim_node: ^UI_AnimNode,
  lru_anim_node: ^UI_AnimNode,
  mru_anim_node: ^UI_AnimNode,
  anim_slots_count: u64,
  anim_slots: ^UI_AnimSlot,
  
  //- rjf: build state machine state
  is_in_open_ctx_menu: B32,
  autocomplete_string: String8,
  tooltip_can_overflow_window: B32,
  tooltip_anchor_key: UI_Key,
  current_gen_tags: String8Array,
  current_gen_tags_gen: u64,
  tags_key_stack_top: ^UI_TagsKeyStackNode,
  tags_key_stack_free: ^UI_TagsKeyStackNode,
  tags_cache_slots_count: u64,
  tags_cache_slots: ^UI_TagsCacheSlot,
  
  //- rjf: theme pattern cache
  theme_pattern_cache_slots_count: u64,
  theme_pattern_cache_slots: ^UI_ThemePatternCacheSlot,
  theme_pattern_cache_node_free: ^UI_ThemePatternCacheNode,
  lru_theme_pattern_cache_node: ^UI_ThemePatternCacheNode,
  mru_theme_pattern_cache_node: ^UI_ThemePatternCacheNode,
  ...
  mouse: Vec2F32,
  animation_dt: f32,
  default_animation_rate: f32,
  
  //- rjf: user interaction state
  hot_box_key: UI_Key,
  active_box_key: [UI_MouseButtonKind_COUNT]UI_Key,
  drop_hot_box_key: UI_Key,
  clipboard_copy_key: UI_Key,
  press_timestamp_history_us: [3][UI_MouseButtonKind_COUNT]u64,
  press_key_history: [3][UI_MouseButtonKind_COUNT]UI_Key,
  press_pos_history: [3][UI_MouseButtonKind_COUNT]Vec2F32,
  drag_start_mouse: Vec2F32,
  drag_state_arena: ^Arena,
  drag_state_data: String8,
  string_hover_arena: ^Arena,
  string_hover_string: String8,
  string_hover_size: f32,
  string_hover_fstrs: DR_FStrList,
  string_hover_begin_us: u64,
  string_hover_build_index: u64,
  last_time_mousemoved_us: u64,
  ...
  using _ : UI_StackNils,
  using _ : UI_DeclStacks,
}
