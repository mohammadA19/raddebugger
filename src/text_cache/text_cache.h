...
void txt_token_chunk_list_push(Arena *arena, TXT_TokenChunkList *list, ulong cap, TXT_Token *token);
...
TXT_TokenArray txt_token_array_from_string__c_cpp(Arena *arena, ulong *bytes_processed_counter, String8 string);
TXT_TokenArray txt_token_array_from_string__odin(Arena *arena, ulong *bytes_processed_counter, String8 string);
TXT_TokenArray txt_token_array_from_string__jai(Arena *arena, ulong *bytes_processed_counter, String8 string);
TXT_TokenArray txt_token_array_from_string__zig(Arena *arena, ulong *bytes_processed_counter, String8 string);
TXT_TokenArray txt_token_array_from_string__disasm_x64_intel(Arena *arena, ulong *bytes_processed_counter, String8 string);
...
ulong txt_off_from_info_pt(TXT_TextInfo *info, TxtPt pt);
TxtPt txt_pt_from_info_off__linear_scan(TXT_TextInfo *info, ulong off);
TXT_TokenArray txt_token_array_from_info_line_num__linear_scan(TXT_TextInfo *info, long line_num);
Rng1U64 txt_expr_off_range_from_line_off_range_string_tokens(ulong off, Rng1U64 line_range, String8 line_text, TXT_TokenArray *line_tokens);
...
String8 txt_string_from_info_data_line_num(TXT_TextInfo *info, String8 data, long line_num);
...
B32 txt_u2p_enqueue_req(U128 hash, TXT_LangKind lang, ulong endt_us);
