...
ulong     demon_lnx_read_memory(int memory_fd, void *dst, ulong src, ulong size);
B32     demon_lnx_write_memory(int memory_fd, ulong dst, void *src, ulong size);
String8 demon_lnx_read_memory_str(Arena *arena, int memory_fd, ulong address);
