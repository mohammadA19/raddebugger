...
internal uint64     demon_lnx_read_memory(int memory_fd, void *dst, uint64 src, uint64 size);
internal B32     demon_lnx_write_memory(int memory_fd, uint64 dst, void *src, uint64 size);
internal String8 demon_lnx_read_memory_str(Arena *arena, int memory_fd, uint64 address);
