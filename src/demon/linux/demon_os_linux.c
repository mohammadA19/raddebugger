...
public static B32 demon_lnx_already_has_halt_injection = false;
public static U64 demon_lnx_halt_code = 0;
public static U64 demon_lnx_halt_user_data = 0;

public static B32 demon_lnx_new_process_pending = false;

public static Arena *demon_lnx_event_arena = 0;
public static DEMON_EventList demon_lnx_queued_events = {0};

public static U32 demon_lnx_ptrace_options = (PTRACE_O_TRACEEXIT|
                                       PTRACE_O_EXITKILL|
                                       PTRACE_O_TRACEFORK|
                                       PTRACE_O_TRACEVFORK|
                                       PTRACE_O_TRACECLONE);
