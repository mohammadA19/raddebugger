...
static U64 dmn_w32_hash_from_string(String8 string);
static U64 dmn_w32_hash_from_id(U64 id);

////////////////////////////////
//~ rjf: Entity Helpers

//- rjf: entity <-> handle
static DMN_Handle dmn_w32_handle_from_entity(DMN_W32_Entity *entity);
static DMN_W32_Entity *dmn_w32_entity_from_handle(DMN_Handle handle);

//- rjf: entity allocation/deallocation
static DMN_W32_Entity *dmn_w32_entity_alloc(DMN_W32_Entity *parent, DMN_W32_EntityKind kind, U64 id);
static void dmn_w32_entity_release(DMN_W32_Entity *entity);

//- rjf: kind*id -> entity
static DMN_W32_Entity *dmn_w32_entity_from_kind_id(DMN_W32_EntityKind kind, U64 id);

////////////////////////////////
//~ rjf: Module Info Extraction

static String8 dmn_w32_full_path_from_module(Arena *arena, DMN_W32_Entity *module);

////////////////////////////////
//~ rjf: Win32-Level Process/Thread Reads/Writes

//- rjf: processes
static U64 dmn_w32_process_read(HANDLE process, Rng1U64 range, void *dst);
static B32 dmn_w32_process_write(HANDLE process, Rng1U64 range, void *src);
static String8 dmn_w32_read_memory_str(Arena *arena, HANDLE process_handle, U64 address);
static String16 dmn_w32_read_memory_str16(Arena *arena, HANDLE process_handle, U64 address);
...
static DMN_W32_ImageInfo dmn_w32_image_info_from_process_base_vaddr(HANDLE process, U64 base_vaddr);

//- rjf: threads
static U16 dmn_w32_real_tag_word_from_xsave(XSAVE_FORMAT *fxsave);
static U16 dmn_w32_xsave_tag_word_from_real_tag_word(U16 ftw);
static B32 dmn_w32_thread_read_reg_block(Arch arch, HANDLE thread, void *reg_block);
static B32 dmn_w32_thread_write_reg_block(Arch arch, HANDLE thread, void *reg_block);

//- rjf: remote thread injection
static DWORD dmn_w32_inject_thread(HANDLE process, U64 start_address);
