...
public static DMN_W32_Shared *dmn_w32_shared = 0;
public static DMN_W32_Entity dmn_w32_entity_nil = {&dmn_w32_entity_nil, &dmn_w32_entity_nil, &dmn_w32_entity_nil, &dmn_w32_entity_nil, &dmn_w32_entity_nil};
public static DMN_W32_GetThreadDescriptionFunctionType *dmn_w32_GetThreadDescription = 0;
[ThreadStatic]
public static B32 dmn_w32_ctrl_thread = 0;
