...
void rd_cfg_id_list_push(Arena *arena, RD_CfgIDList *list, RD_CfgID id)
{
...
RD_CfgIDList rd_cfg_id_list_copy(Arena *arena, RD_CfgIDList *src)
{
...
RD_ViewUIRuleMap* rd_view_ui_rule_map_make(Arena *arena, U64 slots_count)
{
...
void rd_view_ui_rule_map_insert(Arena *arena, RD_ViewUIRuleMap *map, String8 string, RD_ViewUIFunctionType *ui)
{
...
RD_ViewUIRule* rd_view_ui_rule_from_string(String8 string)
{
...
U64 rd_name_bucket_num_from_string_size(U64 size)
{
  U64 bucket_num = 0;
  if(size > 0)
  {
...
void rd_cfg_release_all_children(RD_Cfg *cfg)
{
...
RD_Cfg* rd_cfg_from_id(RD_CfgID id)
{
...
RD_Cfg* rd_cfg_new_replace(RD_Cfg *parent, String8 string)
{
  Temp scratch = scratch_begin(0, 0);
...
RD_Cfg* rd_cfg_new_replacef(RD_Cfg *parent, char *fmt, ...)
{
  Temp scratch = scratch_begin(0, 0);
  va_list args;
  va_start(args, fmt);
...
RD_Cfg* rd_cfg_deep_copy(RD_Cfg *src_root)
{
  RD_CfgRec rec = {0};
...
void rd_cfg_equip_stringf(RD_Cfg *cfg, char *fmt, ...)
{
  Temp scratch = scratch_begin(0, 0);
  va_list args;
  va_start(args, fmt);
...
RD_Cfg* rd_cfg_child_from_string_or_alloc(RD_Cfg *parent, String8 string)
{
...
RD_Cfg* rd_cfg_child_from_string_or_parent(RD_Cfg *parent, String8 string)
{
...
RD_CfgArray rd_cfg_array_from_list(Arena *arena, RD_CfgList *list)
{
  RD_CfgArray array = {0};
...
RD_CfgList rd_cfg_tree_list_from_string(Arena *arena, String8 root_path, String8 string)
{
  RD_CfgList result = {0};
...
String8 rd_string_from_cfg_tree(Arena *arena, String8 root_path, RD_Cfg *cfg)
{
  Temp scratch = scratch_begin(&arena, 1);
...
void rd_cfg_list_push_front(Arena *arena, RD_CfgList *list, RD_Cfg *cfg)
{
  RD_CfgNode *n = push_array(arena, RD_CfgNode, 1);
  n->v = cfg;
  if(list->first != 0)
...
RD_PanelTree rd_panel_tree_from_cfg(Arena *arena, RD_Cfg *cfg)
{
  Temp scratch = scratch_begin(&arena, 1);
...
RD_PanelNodeRec rd_panel_node_rec__depth_first(RD_PanelNode *root, RD_PanelNode *panel, U64 sib_off, U64 child_off)
{
...
RD_PanelNode* rd_panel_node_from_tree_cfg(RD_PanelNode *root, RD_Cfg *cfg)
{
...
Rng2F32 rd_target_rect_from_panel_node_child(Rng2F32 parent_rect, RD_PanelNode *parent, RD_PanelNode *panel)
{
...
Rng2F32 rd_target_rect_from_panel_node(Rng2F32 root_rect, RD_PanelNode *root, RD_PanelNode *panel)
{
  Temp scratch = scratch_begin(0, 0);
...
B32 rd_cfg_is_project_filtered(RD_Cfg *cfg)
{
...
RD_KeyMapNodePtrList rd_key_map_node_ptr_list_from_name(Arena *arena, String8 string)
{
...
RD_KeyMapNodePtrList rd_key_map_node_ptr_list_from_binding(Arena *arena, RD_Binding binding)
{
  RD_KeyMapNodePtrList list = {0};
  {
...
Vec4F32 rd_hsva_from_cfg(RD_Cfg *cfg)
{
  Vec4F32 hsva = {0};
...
Vec4F32 rd_color_from_cfg(RD_Cfg *cfg)
{
...
B32 rd_disabled_from_cfg(RD_Cfg *cfg)
{
...
RD_Location rd_location_from_cfg(RD_Cfg *cfg)
{
...
String8 rd_label_from_cfg(RD_Cfg *cfg)
{
...
String8 rd_expr_from_cfg(RD_Cfg *cfg)
{
...
String8 rd_path_from_cfg(RD_Cfg *cfg)
{
...
D_Target rd_target_from_cfg(Arena *arena, RD_Cfg *cfg)
{
  D_Target target = {0};
...
MD_NodePtrList rd_schemas_from_name(String8 name)
{
  MD_NodePtrList schemas = {0};
...
String8 rd_default_setting_from_names(String8 schema_name, String8 setting_name)
{
  String8 result = {0};
  {
...
String8 rd_setting_from_name(String8 name)
{
  String8 result = {0};
  if(name.size != 0)
  {
...
B32 rd_setting_b32_from_name(String8 name)
{
  B32 result = 0;
...
U64 rd_setting_u64_from_name(String8 name)
{
  U64 result = 0;
  String8 value = rd_setting_from_name(name);
  if(value.size != 0)
...
F32 rd_setting_f32_from_name(String8 name)
{
  F32 result = 0.f;
  String8 value = rd_setting_from_name(name);
  if(value.size != 0)
...
RD_Cfg* rd_immediate_cfg_from_key(String8 string)
{
...
RD_Cfg* rd_immediate_cfg_from_keyf(char *fmt, ...)
{
  Temp scratch = scratch_begin(0, 0);
  va_list args;
  va_start(args, fmt);
...
Vec4F32 rd_color_from_ctrl_entity(CTRL_Entity *entity)
{
  Vec4F32 result = {0};
  if(entity->rgba != 0)
  {
...
RD_Cfg* rd_cfg_from_eval_space(E_Space space)
{
  RD_Cfg *cfg = &rd_nil_cfg;
...
E_Space rd_eval_space_from_cfg(RD_Cfg *cfg)
{
...
String8 rd_cmd_name_from_eval(E_Eval eval)
{
  String8 result = {0};
...
U64 rd_eval_space_gen(void *u, E_Space space)
{
  U64 result = 0;
  switch(space.kind)
  {
...
B32 rd_commit_eval_value_string(E_Eval dst_eval, String8 string)
{
  B32 result = 0;
...
String8 rd_file_path_from_eval(Arena *arena, E_Eval eval)
{
  String8 result = {0};
...
String8 rd_query_from_eval_string(Arena *arena, String8 string)
{
  String8 result = {0};
  {
    Temp scratch = scratch_begin(&arena, 1);
...
RD_Cfg* rd_view_from_eval(RD_Cfg *parent, E_Eval eval)
{
  Temp scratch = scratch_begin(0, 0);
...
RD_ViewState* rd_view_state_from_cfg(RD_Cfg *cfg)
{
...
UI_BOX_CUSTOM_DRAW (rd_watch_row_extras_custom_draw)
{
...
EV_View* rd_view_eval_view(void)
{
  RD_Cfg *view = rd_cfg_from_id(rd_regs()->view);
  RD_ViewState *view_state = rd_view_state_from_cfg(view);
...
String8 rd_view_query_cmd(void)
{
  RD_Cfg *view = rd_cfg_from_id(rd_regs()->view);
  RD_Cfg *query = rd_cfg_child_from_string(view, str8_lit("query"));
  RD_Cfg *cmd = rd_cfg_child_from_string(query, str8_lit("cmd"));
...
String8 rd_view_query_input(void)
{
  RD_Cfg *view = rd_cfg_from_id(rd_regs()->view);
  RD_Cfg *query = rd_cfg_child_from_string(view, str8_lit("query"));
...
String8 rd_view_setting_from_name(String8 name)
{
  RD_Cfg *view = rd_cfg_from_id(rd_regs()->view);
...
E_Value rd_view_setting_value_from_name(String8 name)
{
...
B32 rd_view_setting_b32_from_name(String8 name)
{
...
U64 rd_view_setting_u64_from_name(String8 name)
{
  String8 string = rd_view_setting_from_name(name);
...
F32 rd_view_setting_f32_from_name(String8 name)
{
  String8 string = rd_view_setting_from_name(name);
...
TXT_LangKind rd_lang_kind_from_eval(E_Eval eval)
{
...
Arch rd_arch_from_eval(E_Eval eval)
{
...
void rd_store_view_loading_info(B32 is_loading, U64 progress_u64, U64 progress_u64_target)
{
  RD_Cfg *view = rd_cfg_from_id(rd_regs()->view);
  RD_ViewState *view_state = rd_view_state_from_cfg(view);
...
String8 rd_push_window_title(Arena *arena)
{
...
RD_Cfg* rd_window_from_cfg(RD_Cfg *cfg)
{
  RD_Cfg *result = &rd_nil_cfg;
...
RD_WindowState* rd_window_state_from_cfg(RD_Cfg *cfg)
{
  //- rjf: unpack
...
RD_WindowState* rd_window_state_from_os_handle(OS_Handle os)
{
  RD_WindowState *ws = &rd_nil_window_state;
  {
...
String8 rd_value_string_from_eval(Arena *arena, String8 filter, EV_StringParams *params, FNT_Tag font, F32 font_size, F32 max_size, E_Eval eval)
{
  Temp scratch = scratch_begin(&arena, 1);
  String8List strs = {0};
  {
...
void rd_set_hover_eval(Vec2F32 pos, String8 string)
{
...
void rd_set_autocomp_regs_(E_Eval dst_eval, RD_Regs *regs)
{
  RD_Cfg *window_cfg = rd_cfg_from_id(rd_regs()->window);
  RD_WindowState *ws = rd_window_state_from_cfg(window_cfg);
...
MD_Node* rd_theme_tree_from_name(Arena *arena, HS_Scope *scope, String8 theme_name)
{
  Temp scratch = scratch_begin(&arena, 1);
...
Vec4F32 rd_rgba_from_code_color_slot(RD_CodeColorSlot slot)
{
  RD_WindowState *ws = rd_window_state_from_cfg(rd_cfg_from_id(rd_regs()->window));
...
RD_CodeColorSlot rd_code_color_slot_from_txt_token_kind(TXT_TokenKind kind)
{
...
RD_CodeColorSlot rd_code_color_slot_from_txt_token_kind_lookup_string(TXT_TokenKind kind, String8 string)
{
  RD_CodeColorSlot color = RD_CodeColorSlot_CodeDefault;
...
String8 rd_string_from_exception_code(U32 code)
{
  String8 string = {0};
...
DR_FStrList rd_stop_explanation_fstrs_from_ctrl_event(Arena *arena, CTRL_Event *event)
{
...
RD_VocabInfo* rd_vocab_info_from_code_name(String8 code_name)
{
...
RD_VocabInfo* rd_vocab_info_from_code_name_plural(String8 code_name_plural)
{
  RD_VocabInfo *result = &rd_nil_vocab_info;
...
B32 rd_next_view_cmd(RD_Cmd **cmd)
{
  for(;rd_next_cmd(cmd);)
  {
