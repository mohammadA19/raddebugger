...
public static OS_Handle ipc_sender2main_signal_semaphore = {0};
public static OS_Handle ipc_sender2main_lock_semaphore = {0};
public static U8 *ipc_sender2main_shared_memory_base = 0;
public static OS_Handle ipc_main2sender_signal_semaphore = {0};
public static OS_Handle ipc_main2sender_lock_semaphore = {0};
public static U8 *ipc_main2sender_shared_memory_base = 0;
public static U8  ipc_s2m_ring_buffer[MB(4)] = {0};
public static U64 ipc_s2m_ring_write_pos = 0;
public static U64 ipc_s2m_ring_read_pos = 0;
public static OS_Handle ipc_s2m_ring_mutex = {0};
public static OS_Handle ipc_s2m_ring_cv = {0};
