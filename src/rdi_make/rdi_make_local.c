...
ASYNC_WORK_DEF(rdim_bake_line_tables_work)
{
  ...
  RDIM_LineTableBakeResult *out = new RDIM_LineTableBakeResult[1];
  ...
  ProfScope("sort bake string chunk list map range")
  {
        ...
        slot_idx += 1)
    {
      if(in->src_map->slots[slot_idx] != 0)
      {
        ...
        {
          in->dst_map->slots[slot_idx] = new RDIM_BakeStringChunkList[1];
...
ASYNC_WORK_DEF(rdim_bake_units_work)
{
  ...
  RDIM_UnitBakeResult *out = new RDIM_UnitBakeResult[1];
...
ASYNC_WORK_DEF(rdim_bake_unit_vmap_work)
{
  ...
  RDIM_UnitVMapBakeResult *out = new RDIM_UnitVMapBakeResult[1];
...
ASYNC_WORK_DEF(rdim_bake_src_files_work)
{
  ...
  RDIM_SrcFileBakeResult *out = new RDIM_SrcFileBakeResult[1];
...
ASYNC_WORK_DEF(rdim_bake_udts_work)
{
  ...
  RDIM_UDTBakeResult *out = new RDIM_UDTBakeResult[1];
...
ASYNC_WORK_DEF(rdim_bake_global_variables_work)
{
  ...
  RDIM_GlobalVariableBakeResult *out = new RDIM_GlobalVariableBakeResult[1];
...
ASYNC_WORK_DEF(rdim_bake_global_vmap_work)
{
  ...
  RDIM_GlobalVMapBakeResult *out = new RDIM_GlobalVMapBakeResult[1];
...
ASYNC_WORK_DEF(rdim_bake_thread_variables_work)
{
  ...
  RDIM_ThreadVariableBakeResult *out = new RDIM_ThreadVariableBakeResult[1];
...
ASYNC_WORK_DEF(rdim_bake_constants_work)
{
  ...
  RDIM_ConstantsBakeResult *out = new RDIM_ConstantsBakeResult[1];
...
ASYNC_WORK_DEF(rdim_bake_procedures_work)
{
  ...
  RDIM_ProcedureBakeResult *out = new RDIM_ProcedureBakeResult[1];
...
ASYNC_WORK_DEF(rdim_bake_scopes_work)
{
  ...
  RDIM_ScopeBakeResult *out = new RDIM_ScopeBakeResult[1];
...
ASYNC_WORK_DEF(rdim_bake_scope_vmap_work)
{
  ...
  RDIM_ScopeVMapBakeResult *out = new RDIM_ScopeVMapBakeResult[1];
...
ASYNC_WORK_DEF(rdim_bake_inline_sites_work)
{
  ...
  RDIM_InlineSiteBakeResult *out = new RDIM_InlineSiteBakeResult[1];
...
ASYNC_WORK_DEF(rdim_bake_file_paths_work)
{
  ...
  RDIM_FilePathBakeResult *out = new RDIM_FilePathBakeResult[1];
...
ASYNC_WORK_DEF(rdim_bake_strings_work)
{
  ...
  RDIM_StringBakeResult *out = new RDIM_StringBakeResult[1];
...
ASYNC_WORK_DEF(rdim_bake_type_nodes_work)
{
  ...
  RDIM_TypeNodeBakeResult *out = new RDIM_TypeNodeBakeResult[1];
...
ASYNC_WORK_DEF(rdim_bake_name_map_work)
{
  ...
  RDIM_NameMapBakeResult *out = new RDIM_NameMapBakeResult[1];
...
ASYNC_WORK_DEF(rdim_bake_idx_runs_work)
{
  ...
  RDIM_IndexRunBakeResult *out = new RDIM_IndexRunBakeResult[1];
...
rdim_bake(Arena *arena, ASYNC_Root *async_root, RDIM_BakeParams *in_params)
{
  ...
  {
    RDIM_BakeLineTablesIn *in = new RDIM_BakeLineTablesIn[1];
  ...
  RDIM_BakeStringMapLoose **bake_string_maps__in_progress = new RDIM_BakeStringMapLoose *[async_thread_count()];
  ASYNC_TaskList bake_string_map_build_tasks = {0};
  {
    // rjf: src files
    ProfScope("kick off src files string map build task")
    {
      RDIM_BakeSrcFilesStringsIn *in = new RDIM_BakeSrcFilesStringsIn[1];
    ...
    {
      RDIM_BakeUnitsStringsIn *in = new RDIM_BakeUnitsStringsIn[1];
      in->top = &bake_string_map_topology;
      in->maps = bake_string_maps__in_progress;
    ...
    ProfScope("kick off types string map build tasks")
    {
      ...
      {
        RDIM_BakeTypesStringsIn *in = new RDIM_BakeTypesStringsIn[1];
        in->top = &bake_string_map_topology;
        in->maps = bake_string_maps__in_progress;
        ...
        for(;chunk != 0 && items_left > 0;)
        {
          ...
          RDIM_BakeTypesStringsInNode *n = new RDIM_BakeTypesStringsInNode[1];
    ...
    ProfScope("kick off udts string map build tasks")
    {
      ...
      for(U64 task_idx = 0; task_idx < num_tasks; task_idx += 1)
      {
        RDIM_BakeUDTsStringsIn *in = new RDIM_BakeUDTsStringsIn[1];
        in->top = &bake_string_map_topology;
        in->maps = bake_string_maps__in_progress;
        U64 items_left = items_per_task;
        for(;chunk != 0 && items_left > 0;)
        {
          U64 items_in_this_chunk = Min(items_per_task, chunk->count-chunk_off);
          RDIM_BakeUDTsStringsInNode *n = new RDIM_BakeUDTsStringsInNode[1];
          SLLQueuePush(in->first, in->last, n);
          n->v = chunk->v + chunk_off;
          n->count = items_in_this_chunk;
          chunk_off += items_in_this_chunk;
    ...
    ProfScope("kick off symbols string map build tasks")
    {
      ...
      for(U64 list_idx = 0; list_idx < ArrayCount(symbol_lists); list_idx += 1)
      {
        ...
        for(U64 task_idx = 0; task_idx < num_tasks; task_idx += 1)
        {
          RDIM_BakeSymbolsStringsIn *in = new RDIM_BakeSymbolsStringsIn[1];
          in->top = &bake_string_map_topology;
          in->maps = bake_string_maps__in_progress;
          U64 items_left = items_per_task;
          for(;chunk != 0 && items_left > 0;)
          {
            U64 items_in_this_chunk = Min(items_per_task, chunk->count-chunk_off);
            RDIM_BakeSymbolsStringsInNode *n = new RDIM_BakeSymbolsStringsInNode[1];
            SLLQueuePush(in->first, in->last, n);
            n->v = chunk->v + chunk_off;
            n->count = items_in_this_chunk;
            chunk_off += items_in_this_chunk;
    ...
    ProfScope("kick off inline site string map build task")
    {
      ...
      for(U64 task_idx = 0; task_idx < num_tasks; task_idx += 1)
      {
        RDIM_BakeInlineSiteStringsIn *in = new RDIM_BakeInlineSiteStringsIn[1];
        in->top = &bake_string_map_topology;
        in->maps = bake_string_maps__in_progress;
        U64 items_left = items_per_task;
        for(;chunk != 0 && items_left > 0;)
        {
          U64 items_in_this_chunk = Min(items_per_task, chunk->count-chunk_off);
          RDIM_BakeInlineSiteStringsInNode *n = new RDIM_BakeInlineSiteStringsInNode[1];
          SLLQueuePush(in->first, in->last, n);
          n->v = chunk->v + chunk_off;
          n->count = items_in_this_chunk;
          chunk_off += items_in_this_chunk;
    ...
    ProfScope("kick off scope chunks string map build tasks")
    {
      ...
      for(U64 task_idx = 0; task_idx < num_tasks; task_idx += 1)
      {
        RDIM_BakeScopesStringsIn *in = new RDIM_BakeScopesStringsIn[1];
        in->top = &bake_string_map_topology;
        in->maps = bake_string_maps__in_progress;
        U64 items_left = items_per_task;
        for(;chunk != 0 && items_left > 0;)
        {
          U64 items_in_this_chunk = Min(items_per_task, chunk->count-chunk_off);
          RDIM_BakeScopesStringsInNode *n = new RDIM_BakeScopesStringsInNode[1];
          SLLQueuePush(in->first, in->last, n);
          n->v = chunk->v + chunk_off;
          n->count = items_in_this_chunk;
          chunk_off += items_in_this_chunk;
  ...
  ProfScope("produce joined string map")
  {
    ...
    ASYNC_Task **tasks = new ASYNC_Task *[num_tasks];
    
    // rjf: kickoff tasks
    for(U64 task_idx = 0; task_idx < num_tasks; task_idx += 1)
    {
      RDIM_JoinBakeStringMapSlotsIn *in = new RDIM_JoinBakeStringMapSlotsIn[1];
      in->top = &bake_string_map_topology;
  ...
  RDIM_BakeStringMapLoose *sorted_bake_string_map__in_progress = rdim_bake_string_map_loose_make(arena, &bake_string_map_topology);
  {
    ...
    for(U64 task_idx = 0; task_idx < num_tasks; task_idx += 1)
    {
      RDIM_SortBakeStringMapSlotsIn *in = new RDIM_SortBakeStringMapSlotsIn[1];
      {
        in->top = &bake_string_map_topology;
  ...
  ASYNC_Task *bake_name_maps_tasks[RDI_NameMapKind_COUNT] = {0};
  {
    for EachNonZeroEnumVal(RDI_NameMapKind, k)
    {
      ...
      RDIM_BakeNameMapIn *in = new RDIM_BakeNameMapIn[1];
...
rdim_compress(Arena *arena, RDIM_SerializedSectionBundle *in)
{
  ...
  ctx.m_hashTable = new U16[1<<ctx.m_tableSizeBits];
