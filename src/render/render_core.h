...
static Mat4x4F32 r_sample_channel_map_from_tex2dformat(R_Tex2DFormat fmt);

////////////////////////////////
//~ rjf: Handle Type Functions

static R_Handle r_handle_zero(void);
static B32 r_handle_match(R_Handle a, R_Handle b);

////////////////////////////////
//~ rjf: Batch Type Functions

static R_BatchList r_batch_list_make(U64 instance_size);
static void *r_batch_list_push_inst(Arena *arena, R_BatchList *list, U64 batch_inst_cap);

////////////////////////////////
//~ rjf: Pass Type Functions

static R_Pass *r_pass_from_kind(Arena *arena, R_PassList *list, R_PassKind kind);
