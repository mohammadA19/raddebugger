...
C_LINKAGE_BEGIN
extern StringView r_tex2d_format_display_string_table[9];
extern uint8 r_tex2d_format_bytes_per_pixel_table[9];
extern StringView r_resource_kind_display_string_table[3];
extern StringView r_tex2d_sample_kind_display_string_table[2];
extern StringView r_pass_kind_display_string_table[3];
extern uint8 r_pass_kind_batch_table[3];
