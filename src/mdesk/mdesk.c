...
md_token_array_from_chunk_list(Arena *arena, MD_TokenChunkList *chunks)
{
  ...
  result.v = new MD_Token[result.count] /* no zero */;
  U64 write_idx = 0;
...
if(work_node == 0) {work_node = new MD_ParseWorkNode[1];}\
...
{
  MD_NodePtrNode *n = new MD_NodePtrNode[1];
  n->v = node;
