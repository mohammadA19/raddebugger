...
internal DASM_Inst
dasm_inst_from_code(Arena *arena, Arch arch, U64 vaddr, StringView code, DASM_Syntax syntax)
{
    DASM_Inst inst = {0};
    switch (arch)
    {
...
dasm_ctrl_flow_info_from_arch_vaddr_code(Arena *arena, DASM_InstFlags exit_points_mask, Arch arch, U64 vaddr, StringView code)
{
