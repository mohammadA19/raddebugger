...
static TEX_Topology tex_topology_make(Vec2S32 dim, R_Tex2DFormat fmt);
...
static void tex_tctx_ensure_inited(void);

////////////////////////////////
//~ rjf: Scoped Access

static TEX_Scope *tex_scope_open(void);
static void tex_scope_close(TEX_Scope *scope);
static void tex_scope_touch_node__stripe_r_guarded(TEX_Scope *scope, TEX_Node *node);

////////////////////////////////
//~ rjf: Cache Lookups

static R_Handle tex_texture_from_hash_topology(TEX_Scope *scope, U128 hash, TEX_Topology topology);
static R_Handle tex_texture_from_key_topology(TEX_Scope *scope, HS_Key key, TEX_Topology topology, U128 *hash_out);

////////////////////////////////
//~ rjf: Transfer Threads

static B32 tex_u2x_enqueue_req(U128 hash, TEX_Topology top, U64 endt_us);
static void tex_u2x_dequeue_req(U128 *hash_out, TEX_Topology *top_out);
ASYNC_WORK_DEF(tex_xfer_work);

////////////////////////////////
//~ rjf: Evictor Threads

static void tex_evictor_thread__entry_point(void *p);
