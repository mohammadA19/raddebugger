...
internal TEX_Topology tex_topology_make(Vec2uint32 dim, R_Tex2DFormat fmt);
...
internal R_Handle tex_texture_from_hash_topology(TEX_Scope *scope, uint128 hash, TEX_Topology topology);
internal R_Handle tex_texture_from_key_topology(TEX_Scope *scope, HS_Key key, TEX_Topology topology, uint128 *hash_out);

////////////////////////////////
//~ rjf: Transfer Threads

internal B32 tex_u2x_enqueue_req(uint128 hash, TEX_Topology top, uint64 endt_us);
internal void tex_u2x_dequeue_req(uint128 *hash_out, TEX_Topology *top_out);
