...
REGS_Reg16 :: struct #raw_union {
  U8 v[2];
  U16 u16;
}

REGS_Reg32 :: struct #raw_union {
  U8 v[4];
  U32 u32;
  F32 f32;
}

REGS_Reg64 :: struct #raw_union {
  U8 v[8];
  U64 u64;
  F64 f64;
}
