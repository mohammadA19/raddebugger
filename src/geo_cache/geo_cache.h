...
static void geo_tctx_ensure_inited(void);

////////////////////////////////
//~ rjf: Scoped Access

static GEO_Scope *geo_scope_open(void);
static void geo_scope_close(GEO_Scope *scope);
static void geo_scope_touch_node__stripe_r_guarded(GEO_Scope *scope, GEO_Node *node);

////////////////////////////////
//~ rjf: Cache Lookups

static R_Handle geo_buffer_from_hash(GEO_Scope *scope, U128 hash);
static R_Handle geo_buffer_from_key(GEO_Scope *scope, HS_Key key);

////////////////////////////////
//~ rjf: Transfer Threads

static B32 geo_u2x_enqueue_req(U128 hash, U64 endt_us);
static void geo_u2x_dequeue_req(U128 *hash_out);
ASYNC_WORK_DEF(geo_xfer_work);

////////////////////////////////
//~ rjf: Evictor Threads

static void geo_evictor_thread__entry_point(void *p);
