...
geo_init(void)
{
  ...
  geo_shared->slots = new GEO_Slot[geo_shared->slots_count];
  geo_shared->stripes = new GEO_Stripe[geo_shared->stripes_count];
  geo_shared->stripes_free_nodes = new GEO_Node *[geo_shared->stripes_count];
  ...
  geo_shared->u2x_ring_base = new U8[geo_shared->u2x_ring_size] /* no zero */;
