...
static MSF_RawStreamTable* msf_raw_stream_table_from_data(Arena *arena, String8 msf_data);
static String8             msf_data_from_stream_number(Arena *arena, String8 msf_data, MSF_RawStreamTable *st, MSF_StreamNumber sn);
