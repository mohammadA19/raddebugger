...
typedef struct MSCRT_FuncInfo32V4
{
  ...
  u32                   bbt_flags;
  i32                   unwind_map_voff;
  i32                   try_block_map_voff;
  i32                   ip_to_state_map_voff;
  i32                   wrt_frame_establisher_voff; // used only in catch funclets
} MSCRT_FuncInfo32V4;
