...
static String8 cv_string_from_numeric_kind(CV_NumericKind v);
static String8 cv_string_from_arch(CV_Arch v);
static String8 cv_string_from_sym_kind(CV_SymKind v);
static String8 cv_string_from_basic_type(CV_BasicType v);
static String8 cv_type_name_from_basic_type(CV_BasicType v);
static String8 cv_string_from_leaf_kind(CV_LeafKind v);
static U64 cv_header_struct_size_from_sym_kind(CV_SymKind v);
static U64 cv_header_struct_size_from_leaf_kind(CV_LeafKind v);
