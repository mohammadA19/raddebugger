...
cv_string_from_numeric(Arena *arena, CV_NumericParsed num)
{
  ...
  switch (num.kind) {
    ...
    case CV_NumericKind_CHAR:      result = push_str8f(arena, "%d",   *(i8 *)num.val); break;
    case CV_NumericKind_SHORT:     result = push_str8f(arena, "%d",   *(i16*)num.val); break;
    case CV_NumericKind_LONG:      result = push_str8f(arena, "%d",   *(i32*)num.val); break;
    case CV_NumericKind_QUADWORD:  result = push_str8f(arena, "%lld", *(i64*)num.val); break;
