...
cv_u64_from_numeric(CV_NumericParsed *num)
{
  ...
  switch(num->kind)
  {
    case CV_NumericKind_CHAR:     {result = (u64)(i64)*(i8*)num->val;}break;
    case CV_NumericKind_SHORT:    {result = (u64)(i64)*(i16*)num->val;}break;
    case CV_NumericKind_LONG:     {result = (u64)(i64)*(i32*)num->val;}break;
    case CV_NumericKind_QUADWORD: {result = (u64)(i64)*(i64*)num->val;}break;
...
cv_s64_from_numeric(CV_NumericParsed *num)
{
  ...
  switch(num->kind)
  {
    case CV_NumericKind_CHAR:     {result = *(i8*)num->val;}break;
    case CV_NumericKind_SHORT:    {result = *(i16*)num->val;}break;
    case CV_NumericKind_LONG:     {result = *(i32*)num->val;}break;
    case CV_NumericKind_QUADWORD: {result = *(i64*)num->val;}break;
  }
  return(result);
}
...
internal u64
cv_decode_inline_annot_s32(String8 data, u64 offset, i32 *out_value)
{
  u32 value;
...
cv_c13_inline_site_decoder_init(u32 file_off, u32 first_source_ln, u32 parent_voff)
{
  ...
  decoder.ln                      = (i32)first_source_ln;
  decoder.cn                      = 1;
