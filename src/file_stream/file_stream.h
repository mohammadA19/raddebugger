...
ulong fs_little_hash_from_string(String8 string);
...
U128 fs_hash_from_path_range(String8 path, Rng1U64 range, ulong endt_us);
U128 fs_key_from_path_range(String8 path, Rng1U64 range);

ulong fs_timestamp_from_path(String8 path);
ulong fs_size_from_path(String8 path);

////////////////////////////////
//~ rjf: Streaming Work

B32 fs_u2s_enqueue_req(Rng1U64 range, String8 path, ulong endt_us);
