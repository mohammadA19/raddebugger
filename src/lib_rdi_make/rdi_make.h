...
// #define RDIM_String8_NodeCount <name of uint64 list member containing node count>
// #define RDIM_String8_TotalSizeMember <name of uint64 list member containing total joined string size>
...
struct RDIM_String8List
{
  ...
  RDI_uint64 node_count;
  RDI_uint64 total_size;
};
#endif

typedef RDI_uint32 RDIM_StringMatchFlags;
enum
{
...
typedef uint32 RDIM_SubsetFlags;
enum
{
...
//- rjf: 1-dimensional uint64 ranges

typedef struct RDIM_Rng1uint64 RDIM_Rng1uint64;
struct RDIM_Rng1uint64
{
  RDI_uint64 min;
  RDI_uint64 max;
};

typedef struct RDIM_Rng1uint64Node RDIM_Rng1uint64Node;
struct RDIM_Rng1uint64Node
{
  RDIM_Rng1uint64Node *next;
  RDIM_Rng1uint64 v;
};

typedef struct RDIM_Rng1uint64List RDIM_Rng1uint64List;
struct RDIM_Rng1uint64List
{
  RDIM_Rng1uint64Node *first;
  RDIM_Rng1uint64Node *last;
  RDI_uint64 count;
  RDI_uint64 min;
};

typedef struct RDIM_Rng1uint64ChunkNode RDIM_Rng1uint64ChunkNode;
struct RDIM_Rng1uint64ChunkNode
{
  RDIM_Rng1uint64ChunkNode *next;
  RDIM_Rng1uint64 *v;
  RDI_uint64 count;
  RDI_uint64 cap;
};

typedef struct RDIM_Rng1uint64ChunkList RDIM_Rng1uint64ChunkList;
struct RDIM_Rng1uint64ChunkList
{
  RDIM_Rng1uint64ChunkNode *first;
  RDIM_Rng1uint64ChunkNode *last;
  RDI_uint64 chunk_count;
  RDI_uint64 total_count;
  RDI_uint64 min;
};

//- rjf: u64 -> pointer map

typedef struct RDIM_uint64ToPtrNode RDIM_uint64ToPtrNode;
struct RDIM_uint64ToPtrNode
{
  RDIM_uint64ToPtrNode *next;
  RDI_uint64 _padding_;
  RDI_uint64 key[1];
  void *ptr[1];
};

typedef struct RDIM_uint64ToPtrMap RDIM_uint64ToPtrMap;
struct RDIM_uint64ToPtrMap
{
  RDIM_uint64ToPtrNode **buckets;
  RDI_uint64 buckets_count;
  RDI_uint64 bucket_collision_count;
  RDI_uint64 pair_count;
};

typedef struct RDIM_uint64ToPtrLookup RDIM_uint64ToPtrLookup;
struct RDIM_uint64ToPtrLookup
{
  void *match;
  RDIM_uint64ToPtrNode *fill_node;
  RDI_uint32 fill_k;
};
...
struct RDIM_SrcFileChunkList
{
  ...
  RDI_uint64 chunk_count;
  RDI_uint64 total_count;
  RDI_uint64 source_line_map_count;
  RDI_uint64 total_line_count;
};
...
struct RDIM_LineSequence
{
  ...
  RDI_uint64 *voffs;     // [line_count + 1] (sorted)
  RDI_uint32 *line_nums; // [line_count]
  RDI_uint16 *col_nums;  // [2*line_count]
  RDI_uint64 line_count;
};
...
struct RDIM_LineTable
{
  ...
  RDI_uint64 seq_count;
  RDI_uint64 line_count;
  RDI_uint64 col_count;
};
...
struct RDIM_LineTableChunkList
{
  ...
  RDI_uint64 chunk_count;
  RDI_uint64 total_count;
  RDI_uint64 total_seq_count;
  RDI_uint64 total_line_count;
  RDI_uint64 total_col_count;
};
...
struct RDIM_Unit
{
  ...
  RDIM_Rng1uint64ChunkList voff_ranges;
};
...
typedef RDI_uint32 RDIM_DataModel;
...
struct RDIM_UDTChunkList
{
  ...
  RDI_uint64 chunk_count;
  RDI_uint64 total_count;
  RDI_uint64 total_member_count;
  RDI_uint64 total_enum_val_count;
};
...
struct RDIM_LocationSet
{
  ...
  RDI_uint64 location_case_count;
};
...
struct RDIM_SymbolChunkList
{
  ...
  RDI_uint64 chunk_count;
  RDI_uint64 total_count;
  RDI_uint64 total_value_data_size;
};
...
struct RDIM_Scope
{
  ...
  RDIM_Rng1uint64List voff_ranges;
...
struct RDIM_ScopeChunkList
{
  ...
  RDI_uint64 chunk_count;
  RDI_uint64 total_count;
  RDI_uint64 scope_voff_count;
  RDI_uint64 local_count;
  RDI_uint64 location_count;
};
...
struct RDIM_BakeIdxRunMap
{
  ...
  RDI_uint64 slots_count;
  RDI_uint64 slot_collision_count;
  RDI_uint32 count;
  RDI_uint32 idx_count;
};
...
struct RDIM_BinarySectionBakeResult
{
  ...
  RDI_uint64 binary_sections_count;
};
...
struct RDIM_SrcFileBakeResult
{
  ...
  RDI_uint64 source_files_count;
  RDI_SourceLineMap *source_line_maps;
  RDI_uint64 source_line_maps_count;
  RDI_uint32 *source_line_map_nums;
  RDI_uint32 *source_line_map_rngs;
  RDI_uint64 *source_line_map_voffs;
  RDI_uint64 source_line_map_nums_count;
  RDI_uint64 source_line_map_rngs_count;
  RDI_uint64 source_line_map_voffs_count;
};
...
struct RDIM_LineTableBakeResult
{
  ...
  RDI_uint64 line_tables_count;
  RDI_uint64 *line_table_voffs;
  RDI_uint64 line_table_voffs_count;
  RDI_Line *line_table_lines;
  RDI_uint64 line_table_lines_count;
  RDI_Column *line_table_columns;
  RDI_uint64 line_table_columns_count;
};
...
{
  RDI_UDT *udts;
  RDI_uint64 udts_count;
  RDI_Member *members;
  RDI_uint64 members_count;
  RDI_EnumMember *enum_members;
  RDI_uint64 enum_members_count;
};
...
struct RDIM_GlobalVariableBakeResult
{
  ...
  RDI_uint64 global_variables_count;
};
...
struct RDIM_ThreadVariableBakeResult
{
  ...
  RDI_uint64 thread_variables_count;
};
...
struct RDIM_ConstantsBakeResult
{
  ...
  RDI_uint64 constants_count;
  RDI_uint32 *constant_values;
  RDI_uint64 constant_values_count;
  RDI_uint8 *constant_value_data;
  RDI_uint64 constant_value_data_size;
};
...
{
  RDI_Scope *scopes;
  RDI_uint64 scopes_count;
  RDI_uint64 *scope_voffs;
  RDI_uint64 scope_voffs_count;
  RDI_Local *locals;
  RDI_uint64 locals_count;
};
...
{
  RDI_uint32 *string_offs;
  RDI_uint64 string_offs_count;
  RDI_uint8 *string_data;
  RDI_uint64 string_data_size;
};
...
RDI_PROC void *rdim_memset_fallback(void *dst, RDI_uint8 c, RDI_uint64 size);
#endif
#if !defined(RDIM_MEMCPY_OVERRIDE)
RDI_PROC void *rdim_memcpy_fallback(void *dst, void *src, RDI_uint64 size);
#endif
...
RDI_PROC RDI_uint64 rdim_arena_pos_fallback(RDIM_Arena *arena);
RDI_PROC void *rdim_arena_push_fallback(RDIM_Arena *arena, RDI_uint64 align, RDI_uint64 size);
RDI_PROC void rdim_arena_pop_to_fallback(RDIM_Arena *arena, RDI_uint64 pos);
#endif
...
RDI_PROC RDIM_Temp rdim_scratch_begin_fallback(RDIM_Arena **conflicts, RDI_uint64 conflicts_count);
RDI_PROC void rdim_scratch_end_fallback(RDIM_Temp temp);
#endif

//- rjf: strings
RDI_PROC RDIM_String8 rdim_str8(RDI_uint8 *str, RDI_uint64 size);
...
RDI_PROC RDI_uint32 rdim_str8_match(RDIM_String8 a, RDIM_String8 b, RDIM_StringMatchFlags flags);
#define rdim_str8_lit(S)              rdim_str8((RDI_uint8*)(S), sizeof(S) - 1)
#define rdim_str8_struct(S)           rdim_str8((RDI_uint8*)(S), sizeof(*(S)))
#define rdim_str8_struct_array(S, C)  rdim_str8((RDI_uint8*)(S), sizeof(*(S)) * (C))
...
RDI_PROC void rdim_str8_list_push_align(RDIM_Arena *arena, RDIM_String8List *list, RDI_uint64 align);
...
RDI_PROC RDIM_SortKey *rdim_sort_key_array(RDIM_Arena *arena, RDIM_SortKey *keys, RDI_uint64 count);

//- rjf: rng1u64 lists
RDI_PROC void rdim_rng1u64_list_push(RDIM_Arena *arena, RDIM_Rng1uint64List *list, RDIM_Rng1uint64 r);
RDI_PROC void rdim_rng1u64_chunk_list_push(RDIM_Arena *arena, RDIM_Rng1uint64ChunkList *list, RDI_uint64 chunk_cap, RDIM_Rng1uint64 r);
...
RDI_PROC RDIM_SrcFile *rdim_src_file_chunk_list_push(RDIM_Arena *arena, RDIM_SrcFileChunkList *list, RDI_uint64 cap);
RDI_PROC RDI_uint64 rdim_idx_from_src_file(RDIM_SrcFile *src_file);
...
RDI_PROC RDIM_LineTable *rdim_line_table_chunk_list_push(RDIM_Arena *arena, RDIM_LineTableChunkList *list, RDI_uint64 cap);
RDI_PROC RDI_uint64 rdim_idx_from_line_table(RDIM_LineTable *line_table);
RDI_PROC void rdim_line_table_chunk_list_concat_in_place(RDIM_LineTableChunkList *dst, RDIM_LineTableChunkList *to_push);
RDI_PROC RDIM_LineSequence *rdim_line_table_push_sequence(RDIM_Arena *arena, RDIM_LineTableChunkList *line_tables, RDIM_LineTable *line_table, RDIM_SrcFile *src_file, RDI_uint64 *voffs, RDI_uint32 *line_nums, RDI_uint16 *col_nums, RDI_uint64 line_count);

////////////////////////////////
//~ rjf: [Building] Unit Info Building

RDI_PROC RDIM_Unit *rdim_unit_chunk_list_push(RDIM_Arena *arena, RDIM_UnitChunkList *list, RDI_uint64 cap);
RDI_PROC RDI_uint64 rdim_idx_from_unit(RDIM_Unit *unit);
...
RDI_PROC RDIM_Type *rdim_type_chunk_list_push(RDIM_Arena *arena, RDIM_TypeChunkList *list, RDI_uint64 cap);
RDI_PROC RDI_uint64 rdim_idx_from_type(RDIM_Type *type);
RDI_PROC void rdim_type_chunk_list_concat_in_place(RDIM_TypeChunkList *dst, RDIM_TypeChunkList *to_push);
RDI_PROC RDIM_UDT *rdim_udt_chunk_list_push(RDIM_Arena *arena, RDIM_UDTChunkList *list, RDI_uint64 cap);
RDI_PROC RDI_uint64 rdim_idx_from_udt(RDIM_UDT *udt);
...
RDI_PROC RDIM_Symbol *rdim_symbol_chunk_list_push(RDIM_Arena *arena, RDIM_SymbolChunkList *list, RDI_uint64 cap);
RDI_PROC RDI_uint64 rdim_idx_from_symbol(RDIM_Symbol *symbol);
...
RDI_PROC RDIM_InlineSite *rdim_inline_site_chunk_list_push(RDIM_Arena *arena, RDIM_InlineSiteChunkList *list, RDI_uint64 cap);
RDI_PROC RDI_uint64 rdim_idx_from_inline_site(RDIM_InlineSite *inline_site);
...
//- rjf: scopes
RDI_PROC RDIM_Scope *rdim_scope_chunk_list_push(RDIM_Arena *arena, RDIM_ScopeChunkList *list, RDI_uint64 cap);
RDI_PROC RDI_uint64 rdim_idx_from_scope(RDIM_Scope *scope);
RDI_PROC void rdim_scope_chunk_list_concat_in_place(RDIM_ScopeChunkList *dst, RDIM_ScopeChunkList *to_push);
RDI_PROC void rdim_scope_push_voff_range(RDIM_Arena *arena, RDIM_ScopeChunkList *list, RDIM_Scope *scope, RDIM_Rng1uint64 range);
RDI_PROC RDIM_Local *rdim_scope_push_local(RDIM_Arena *arena, RDIM_ScopeChunkList *scopes, RDIM_Scope *scope);

//- rjf: bytecode
RDI_PROC void rdim_bytecode_push_op(RDIM_Arena *arena, RDIM_EvalBytecode *bytecode, RDI_EvalOp op, RDI_uint64 p);
RDI_PROC void rdim_bytecode_push_uconst(RDIM_Arena *arena, RDIM_EvalBytecode *bytecode, RDI_uint64 x);
RDI_PROC void rdim_bytecode_push_sconst(RDIM_Arena *arena, RDIM_EvalBytecode *bytecode, RDI_uint64 x);
...
RDI_PROC RDIM_Location *rdim_push_location_addr_reg_plus_u16(RDIM_Arena *arena, RDI_uint8 reg_code, RDI_uint16 offset);
RDI_PROC RDIM_Location *rdim_push_location_addr_addr_reg_plus_u16(RDIM_Arena *arena, RDI_uint8 reg_code, RDI_uint16 offset);
RDI_PROC RDIM_Location *rdim_push_location_val_reg(RDIM_Arena *arena, RDI_uint8 reg_code);

//- rjf: location sets
RDI_PROC void rdim_location_set_push_case(RDIM_Arena *arena, RDIM_ScopeChunkList *scopes, RDIM_LocationSet *locset, RDIM_Rng1uint64 voff_range, RDIM_Location *location);

//- rjf:location block chunk list
RDI_PROC RDI_LocationBlock *rdim_location_block_chunk_list_push_array(RDIM_Arena *arena, RDIM_String8List *list, RDI_uint32 count);
RDI_PROC RDI_uint32 rdim_count_from_location_block_chunk_list(RDIM_String8List *list);
...
RDI_PROC RDIM_BakeVMap rdim_bake_vmap_from_markers(RDIM_Arena *arena, RDIM_VMapMarker *markers, RDIM_SortKey *keys, RDI_uint64 marker_count);

////////////////////////////////
//~ rjf: [Baking Helpers] Interned / Deduplicated Blob Data Structure Helpers

//- rjf: bake string chunk lists
RDI_PROC RDIM_BakeString *rdim_bake_string_chunk_list_push(RDIM_Arena *arena, RDIM_BakeStringChunkList *list, RDI_uint64 cap);
...
RDI_PROC void rdim_bake_string_map_loose_insert(RDIM_Arena *arena, RDIM_BakeStringMapTopology *map_topology, RDIM_BakeStringMapLoose *map, RDI_uint64 chunk_cap, RDIM_String8 string);
...
RDI_PROC RDI_uint32 rdim_bake_idx_from_string(RDIM_BakeStringMapTight *map, RDIM_String8 string);

//- rjf: bake idx run map reading/writing
RDI_PROC RDI_uint64 rdim_hash_from_idx_run(RDI_uint32 *idx_run, RDI_uint32 count);
RDI_PROC RDI_uint32 rdim_bake_idx_from_idx_run(RDIM_BakeIdxRunMap *map, RDI_uint32 *idx_run, RDI_uint32 count);
RDI_PROC RDI_uint32 rdim_bake_idx_run_map_insert(RDIM_Arena *arena, RDIM_BakeIdxRunMap *map, RDI_uint32 *idx_run, RDI_uint32 count);
...
RDI_PROC RDI_uint32 rdim_bake_path_node_idx_from_string(RDIM_BakePathTree *tree, RDIM_String8 string);
...
RDI_PROC void rdim_bake_name_map_push(RDIM_Arena *arena, RDIM_BakeNameMap *map, RDIM_String8 string, RDI_uint32 idx);
...
RDI_PROC RDIM_BakeSection *rdim_bake_section_list_push_new_unpacked(RDIM_Arena *arena, RDIM_BakeSectionList *list, void *data, RDI_uint64 size, RDI_SectionKind tag, RDI_uint64 tag_idx);
...
RDI_PROC void rdim_bake_string_map_loose_push_src_file_slice(RDIM_Arena *arena, RDIM_BakeStringMapTopology *top, RDIM_BakeStringMapLoose *map, RDIM_SrcFile *v, RDI_uint64 count);
RDI_PROC void rdim_bake_string_map_loose_push_unit_slice(RDIM_Arena *arena, RDIM_BakeStringMapTopology *top, RDIM_BakeStringMapLoose *map, RDIM_Unit *v, RDI_uint64 count);
RDI_PROC void rdim_bake_string_map_loose_push_type_slice(RDIM_Arena *arena, RDIM_BakeStringMapTopology *top, RDIM_BakeStringMapLoose *map, RDIM_Type *v, RDI_uint64 count);
RDI_PROC void rdim_bake_string_map_loose_push_udt_slice(RDIM_Arena *arena, RDIM_BakeStringMapTopology *top, RDIM_BakeStringMapLoose *map, RDIM_UDT *v, RDI_uint64 count);
RDI_PROC void rdim_bake_string_map_loose_push_symbol_slice(RDIM_Arena *arena, RDIM_BakeStringMapTopology *top, RDIM_BakeStringMapLoose *map, RDIM_Symbol *v, RDI_uint64 count);
RDI_PROC void rdim_bake_string_map_loose_push_inline_site_slice(RDIM_Arena *arena, RDIM_BakeStringMapTopology *top, RDIM_BakeStringMapLoose *map, RDIM_InlineSite *v, RDI_uint64 count);

RDI_PROC void rdim_bake_string_map_loose_push_scope_slice(RDIM_Arena *arena, RDIM_BakeStringMapTopology *top, RDIM_BakeStringMapLoose *map, RDIM_Scope *v, RDI_uint64 count);
...
RDI_PROC RDIM_NameMapBakeResult         rdim_name_map_bake_results_combine(RDIM_Arena *arena, RDIM_NameMapBakeResult *results, RDI_uint64 results_count);
...
RDI_PROC RDIM_SerializedSection rdim_serialized_section_make_unpacked(void *data, RDI_uint64 size);
