...
internal U64 dw_hash_from_string(string string);

// deserial helpers

internal U64 str8_deserial_read_dwarf_packed_size(string string, U64 off, U64 *size_out);
internal U64 str8_deserial_read_dwarf_uint       (string string, U64 off, DW_Format format, U64 *uint_out);
internal U64 str8_deserial_read_uleb128          (string string, U64 off, U64 *value_out);
internal U64 str8_deserial_read_sleb128          (string string, U64 off, S64 *value_out);
internal U64 str8_deserial_read_uleb128_array(Arena *arena, string string, U64 off, U64 count, U64 **arr_out);
internal U64 str8_deserial_read_sleb128_array(Arena *arena, string string, U64 off, U64 count, S64 **arr_out);

internal Rng1U64List dw_unit_ranges_from_data(Arena *arena, string data);

// list units

internal U64 dw_read_list_unit_header_addr       (string unit_data, DW_ListUnit *lu_out);
internal U64 dw_read_list_unit_header_str_offsets(string unit_data, DW_ListUnit *lu_out);
internal U64 dw_read_list_unit_header_list       (string unit_data, DW_ListUnit *lu_out);
...
internal U64            dw_read_abbrev_tag   (string data, U64 offset, DW_Abbrev *out_abbrev);
internal U64            dw_read_abbrev_attrib(string data, U64 offset, DW_Abbrev *out_abbrev);
internal DW_AbbrevTable dw_make_abbrev_table(Arena *arena, string abbrev_data, U64 start_abbrev_off);
internal U64            dw_abbrev_offset_from_abbrev_id(DW_AbbrevTable table, U64 abbrev_id);

// form and tag

internal U64 dw_read_form(string data, U64 off, DW_Version version, DW_Format unit_format, U64 address_size, DW_FormKind form_kind, U64 implicit_const, DW_Form *form_out);
internal U64 dw_read_tag   (Arena *arena, string tag_data, U64 tag_off, U64 tag_base, DW_AbbrevTable abbrev_table, string abbrev_data, DW_Version version, DW_Format unit_format, U64 address_size, DW_Tag *tag_out);
...
internal string       dw_interp_exprloc   (DW_FormKind form_kind, DW_Form form);
...
internal string       dw_interp_block     (DW_Input *input, DW_CompUnit *cu, DW_FormKind form_kind, DW_Form form);
internal string       dw_interp_string    (DW_Input *input, DW_Format unit_format, DW_ListUnit *str_offsets, DW_FormKind form_kind, DW_Form form);
internal string       dw_interp_line_ptr  (DW_Input *input, DW_FormKind form_kind, DW_Form form);
...
internal string       dw_exprloc_from_attrib   (DW_Input *input, DW_CompUnit *cu, DW_Attrib *attrib);
...
internal string       dw_block_from_attrib     (DW_Input *input, DW_CompUnit *cu, DW_Attrib *attrib);
internal string       dw_string_from_attrib    (DW_Input *input, DW_CompUnit *cu, DW_Attrib *attrib);
internal string       dw_line_ptr_from_attrib  (DW_Input *input, DW_CompUnit *cu, DW_Attrib *attrib);
...
internal string       dw_exprloc_from_tag_attrib_kind   (DW_Input *input, DW_CompUnit *cu, DW_Tag tag, DW_AttribKind kind);
...
internal string       dw_block_from_tag_attrib_kind     (DW_Input *input, DW_CompUnit *cu, DW_Tag tag, DW_AttribKind kind);
internal string       dw_string_from_tag_attrib_kind    (DW_Input *input, DW_CompUnit *cu, DW_Tag tag, DW_AttribKind kind);
internal string       dw_line_ptr_from_tag_attrib_kind  (DW_Input *input, DW_CompUnit *cu, DW_Tag tag, DW_AttribKind kind);
internal string       dw_line_ptr_from_tag_attrib_kind  (DW_Input *input, DW_CompUnit *cu, DW_Tag tag, DW_AttribKind kind);
...
internal U64 dw_read_line_file(string      line_data,
                               U64          line_off,
                               DW_Input    *input,
...
internal string          dw_path_from_file(Arena *arena, DW_LineVMHeader *vm, DW_LineFile *file);
internal string          dw_path_from_file_idx(Arena *arena, DW_LineVMHeader *vm, U64 file_idx);

internal DW_LineTableParseResult dw_parsed_line_table_from_data(Arena *arena, string unit_data, DW_Input *input, string cu_dir, string cu_name, U8 cu_address_size, DW_ListUnit *cu_str_offsets);
