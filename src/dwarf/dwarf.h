...
static U64 dw_reg_size_from_code_x86(DW_Reg reg_code);
static U64 dw_reg_pos_from_code_x86(DW_Reg reg_code);
static U64 dw_reg_size_from_code_x64(DW_Reg reg_code);
static U64 dw_reg_pos_from_code_x64(DW_Reg reg_code);
static U64 dw_reg_size_from_code(Arch arch, DW_Reg reg_code);
static U64 dw_reg_pos_from_code(Arch arch, DW_Reg reg_code);

//- Attrib Class Encodings

// Speced Encodings
static DW_AttribClass dw_attrib_class_from_attrib_v2(DW_AttribKind k);
static DW_AttribClass dw_attrib_class_from_attrib_v3(DW_AttribKind k);
static DW_AttribClass dw_attrib_class_from_attrib_v4(DW_AttribKind k);
static DW_AttribClass dw_attrib_class_from_attrib_v5(DW_AttribKind k);

// Extensions
static DW_AttribClass dw_attrib_class_from_attrib_gnu  (DW_AttribKind k);
static DW_AttribClass dw_attrib_class_from_attrib_llvm (DW_AttribKind k);
static DW_AttribClass dw_attrib_class_from_attrib_apple(DW_AttribKind k);
static DW_AttribClass dw_attrib_class_from_attrib_mips (DW_AttribKind k);

static DW_AttribClass dw_attrib_class_from_attrib(DW_Version ver, DW_Ext ext, DW_AttribKind v);

//- Form Class Encodings

static DW_AttribClass dw_attrib_class_from_form_kind(DW_Version ver, DW_FormKind k);

static B32 dw_are_attrib_class_and_form_kind_compatible(DW_Version ver, DW_AttribClass attrib_class, DW_FormKind form_kind);

//- Section Names

static String8 dw_name_string_from_section_kind     (DW_SectionKind k);
static String8 dw_mach_name_string_from_section_kind(DW_SectionKind k);
static String8 dw_dwo_name_string_from_section_kind (DW_SectionKind k);

////////////////////////////////

static U64 dw_size_from_format(DW_Format format);

////////////////////////////////

static DW_AttribClass dw_pick_attrib_value_class(DW_Version ver, DW_Ext ext, B32 relaxed, DW_AttribKind attrib, DW_FormKind form_kind);

static U64 dw_pick_default_lower_bound(DW_Language lang);

////////////////////////////////
//~ rjf: String <=> Enum

static String8 dw_string_from_expr_op(Arena *arena, DW_Version ver, DW_Ext ext, DW_ExprOp op);
static String8 dw_string_from_tag_kind(Arena *arena, DW_TagKind kind);
static String8 dw_string_from_attrib_kind(Arena *arena, DW_Version ver, DW_Ext ext, DW_AttribKind kind);
static String8 dw_string_from_form_kind(Arena *arena, DW_Version ver, DW_FormKind kind);
static String8 dw_string_from_language(Arena *arena, DW_Language kind);
static String8 dw_string_from_inl(Arena *arena, DW_InlKind kind);
static String8 dw_string_from_access_kind(Arena *arena, DW_AccessKind kind);
static String8 dw_string_from_calling_convetion(Arena *arena, DW_CallingConventionKind kind);
static String8 dw_string_from_attrib_type_encoding(Arena *arena, DW_ATE kind);
static String8 dw_string_from_std_opcode(Arena *arena, DW_StdOpcode kind);
static String8 dw_string_from_ext_opcode(Arena *arena, DW_ExtOpcode kind);
static String8 dw_string_from_loc_list_entry_kind(Arena *arena, DW_LLE kind);
static String8 dw_string_from_section_kind(Arena *arena, DW_SectionKind kind);
static String8 dw_string_from_rng_list_entry_kind(Arena *arena, DW_RLE kind);
static String8 dw_string_from_register(Arena *arena, Arch arch, U64 reg_id);
