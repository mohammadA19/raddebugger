...
COFF_ParsedSymbol coff_parse_symbol32(String8 string_table, COFF_Symbol32 *sym32)
{
...
COFF_Symbol32Array coff_symbol_array_from_data_16(Arena *arena, String8 raw_coff, U64 symbol_array_off, U64 symbol_count)
{
...
COFF_RelocNode* coff_reloc_list_push(Arena *arena, COFF_RelocList *list, COFF_Reloc reloc)
{
...
String8 coff_write_resource(Arena          *arena,
...
int coff_resource_id_compar(void *raw_a, void *raw_b)
{
  int cmp;
...
void coff_archive_member_list_push_node(COFF_ArchiveMemberList *list, COFF_ArchiveMemberNode *node)
{
  SLLQueuePush(list->first, list->last, node);
  list->count += 1;
}

COFF_ArchiveParse coff_archive_parse_from_member_list(COFF_ArchiveMemberList member_list)
{
