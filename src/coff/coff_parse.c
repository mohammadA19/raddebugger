...
coff_section_table_from_data(Arena *arena, StringView data, Rng1U64 section_table_range)
{
...
coff_parse_symbol32(StringView string_table, COFF_Symbol32 *sym32)
{
...
internal COFF_ParsedSymbol
coff_parse_symbol16(StringView string_table, COFF_Symbol16 *sym16)
{
    COFF_ParsedSymbol result = {0};
...
internal COFF_ParsedSymbol
coff_parse_symbol(COFF_FileHeaderInfo header, StringView string_table, StringView symbol_table, U32 symbol_idx)
{
...
coff_symbol_array_from_data_16(Arena *arena, StringView raw_coff, U64 symbol_array_off, U64 symbol_count)
{
...
internal COFF_Symbol32Array
coff_symbol_array_from_data_32(Arena *arena, StringView data, U64 symbol_array_off, U64 symbol_count)
{
...
internal COFF_Symbol32Array
coff_symbol_array_from_data(Arena *arena, StringView data, U64 symbol_array_off, U64 symbol_count, U64 symbol_size)
{
    COFF_Symbol32Array result = {0};
    switch (symbol_size) {
...
internal U64
coff_read_resource_id_utf16(StringView raw_res, U64 off, COFF_ResourceID16 *id_out)
{
    U64 cursor = off;
...
internal U64
coff_read_resource(Arena *arena, StringView raw_res, U64 off, COFF_ParsedResource *res_out)
{
...
internal U64
coff_parse_archive_member_header(StringView raw_archive, U64 offset, COFF_ParsedArchiveMemberHeader *header_out)
{
...
coff_parse_long_name(StringView long_names, StringView name)
{
    ...
    if (name.size > 0 && name.str[0] == '/') {
        StringView offset_str = str8(name.str + 1, name.size - 1);
...
internal U64
coff_parse_import(StringView raw_archive_member, U64 offset, COFF_ParsedArchiveImportHeader *header_out)
{
...
coff_archive_member_from_offset(StringView raw_archive, U64 offset)
{
...
internal B32
coff_regular_archive_member_iter_next(StringView raw_archive, U64 *offset, COFF_ArchiveMember *member_out)
{
    B32 is_parsed = 0;
...
internal B32
coff_thin_archive_member_iter_next(StringView raw_archive, U64 *offset, COFF_ArchiveMember *member_out)
{
    B32 is_parsed = 0;
