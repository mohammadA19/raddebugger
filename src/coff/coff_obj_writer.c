...
coff_obj_writer_serialize(Arena *arena, COFF_ObjWriter *obj_writer)
{
    ...
    *string_table_size = sizeof(*string_table_size);
    ...
    // join
    //
    StringView obj = str8_list_join(arena, &srl, 0);
...
coff_obj_writer_push_section(COFF_ObjWriter *obj_writer, StringView name, COFF_SectionFlags flags, StringView data)
{
...
coff_obj_writer_push_symbol(COFF_ObjWriter *obj_writer, StringView name, U32 value, COFF_SymbolLocation loc, COFF_SymbolType type, COFF_SymStorageClass storage_class)
{
...
internal COFF_ObjSymbol *
coff_obj_writer_push_symbol_extern(COFF_ObjWriter *obj_writer, StringView name, U32 value, COFF_ObjSection *section)
{
...
internal COFF_ObjSymbol *
coff_obj_writer_push_symbol_extern_func(COFF_ObjWriter *obj_writer, StringView name, U32 value, COFF_ObjSection *section)
{
...
internal COFF_ObjSymbol *
coff_obj_writer_push_symbol_static(COFF_ObjWriter *obj_writer, StringView name, U32 off, COFF_ObjSection *section)
{
    COFF_SymbolLocation loc = {0};
    loc.type                = COFF_SymbolLocation_Section;
    loc.u.section           = section;
...
internal COFF_ObjSymbol *
coff_obj_writer_push_symbol_weak(COFF_ObjWriter *obj_writer, StringView name, COFF_WeakExtType characteristics, COFF_ObjSymbol *tag)
{
    COFF_SymbolLocation loc     = {0};
    COFF_SymbolType     symtype = {0};
...
internal COFF_ObjSymbol *
coff_obj_writer_push_symbol_abs(COFF_ObjWriter *obj_writer, StringView name, U32 value, COFF_SymStorageClass storage_class)
{
    COFF_SymbolLocation loc = {0};
...
internal COFF_ObjSymbol *
coff_obj_writer_push_symbol_undef(COFF_ObjWriter *obj_writer, StringView name)
{
...
internal COFF_ObjSymbol *
coff_obj_writer_push_symbol_undef_func(COFF_ObjWriter *obj_writer, StringView name)
{
    COFF_SymbolType type = {0};
...
internal COFF_ObjSymbol *
coff_obj_writer_push_symbol_undef_sect(COFF_ObjWriter *obj_writer, StringView name, U32 value)
{
    COFF_SymbolType type = {0};
    COFF_SymbolLocation loc = {0};
    loc.type = COFF_SymbolLocation_Undef;
...
internal COFF_ObjSymbol *
coff_obj_writer_push_symbol_sect(COFF_ObjWriter *obj_writer, StringView name, COFF_ObjSection *sect)
{
    COFF_SymbolType type = {0};
    COFF_SymbolLocation loc = {0};
    loc.type      = COFF_SymbolLocation_Section;
...
internal COFF_ObjSymbol *
coff_obj_writer_push_symbol_common(COFF_ObjWriter *obj_writer, StringView name, U32 size)
{
    COFF_SymbolType type = {0};
    COFF_SymbolLocation loc = {0};
...
internal void
coff_obj_writer_push_directive(COFF_ObjWriter *obj_writer, StringView directive)
{
    if (obj_writer.drectve_sect == 0) {
        local_persist const U8 bom_sig[]  = { ' ', ' ', ' ' };
        obj_writer.drectve_sect = coff_obj_writer_push_section(obj_writer, (".drectve"), COFF_SectionFlag_LnkInfo|COFF_SectionFlag_LnkRemove|COFF_SectionFlag_Align1Bytes, str8_array_fixed(bom_sig));
    }
