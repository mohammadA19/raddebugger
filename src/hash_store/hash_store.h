...
static U64 hs_little_hash_from_data(String8 data);
static U128 hs_hash_from_data(String8 data);
static HS_ID hs_id_make(U64 u64_0, U64 u64_1);
static B32 hs_id_match(HS_ID a, HS_ID b);
static HS_Key hs_key_make(HS_Root root, HS_ID id);
static B32 hs_key_match(HS_Key a, HS_Key b);
...
static HS_Root hs_root_alloc(void);
static void hs_root_release(HS_Root root);

////////////////////////////////
//~ rjf: Cache Submission

static U128 hs_submit_data(HS_Key key, Arena **data_arena, String8 data);

////////////////////////////////
//~ rjf: Scoped Access

static HS_Scope *hs_scope_open(void);
static void hs_scope_close(HS_Scope *scope);
static void hs_scope_touch_node__stripe_r_guarded(HS_Scope *scope, HS_Node *node);

////////////////////////////////
//~ rjf: Downstream Accesses

static void hs_hash_downstream_inc(U128 hash);
static void hs_hash_downstream_dec(U128 hash);

////////////////////////////////
//~ rjf: Cache Lookups

static U128 hs_hash_from_key(HS_Key key, U64 rewind_count);
static String8 hs_data_from_hash(HS_Scope *scope, U128 hash);

////////////////////////////////
//~ rjf: Evictor Thread

static void hs_evictor_thread__entry_point(void *p);
