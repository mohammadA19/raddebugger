...
public static void async_init(CmdLine* cmdline)
{
...
public static uint64 async_thread_count()
{
...
public static B32 async_push_work_(ASYNC_WorkFunctionType* work_function, ASYNC_WorkParams* params)
{
  // rjf: choose ring
  ASYNC_Ring* ring = &async_shared.rings[params.priority];
  
  // rjf: build work package 
  ASYNC_Work work = default;
...
public static void async_task_list_push(Arena* arena, ASYNC_TaskList* list, ASYNC_Task* t)
{
...
public static ASYNC_Task* async_task_launch_(Arena* arena, ASYNC_WorkFunctionType* work_function, ASYNC_WorkParams* params)
{
  ASYNC_Task* task = push_array(arena, ASYNC_Task, 1);
  task.semaphore = os_semaphore_alloc(1, 1, str8_zero());
  ASYNC_WorkParams params_refined = default;
...
public static void* async_task_join(ASYNC_Task* task)
{
  void* result = 0;
...
public static ASYNC_Work async_pop_work()
{
  ProfBeginFunction();
  ASYNC_Work work = default;
  B32 done = 0;
...
public static void async_execute_work(ASYNC_Work work)
{
  //- rjf: run work
...
public static void async_work_thread__entry_point(void* p)
{
