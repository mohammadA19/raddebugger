...
static FP_DWrite_Font fp_dwrite_font_from_handle(FP_Handle handle);
static FP_Handle fp_dwrite_handle_from_font(FP_DWrite_Font font);

//- rjf: file stream allocator
static FP_DWrite_FontFileStreamNode *fp_dwrite_font_file_stream_node_alloc(String8 *data_ptr);
static void fp_dwrite_font_file_stream_node_release(FP_DWrite_FontFileStreamNode *node);

//- rjf: iunknown no-op helpers
static HRESULT fp_dwrite_iunknown_noop__query_interface(void *obj, REFIID riid, void *ptr_to_object);
static ULONG fp_dwrite_iunknown_noop__add_ref(void *obj);
static ULONG fp_dwrite_iunknown_noop__release(void *obj);

//- rjf: font file loader interface function implementations
static HRESULT fp_dwrite_static_font_file_loader__stream_from_key(FP_DWrite_FontFileLoader *obj, void const *font_file_ref_key, UINT32 font_file_ref_key_size, IDWriteFontFileStream **stream_out);

//- rjf: font file stream  interface function implementations
static HRESULT fp_dwrite_static_font_file_stream__read_file_fragment(FP_DWrite_FontFileStream *obj, void const **fragment_start, UINT64 file_offset, UINT64 fragment_size, void **fragment_context);
static HRESULT fp_dwrite_static_font_file_stream__release_file_fragment(FP_DWrite_FontFileStream *obj, void *fragment_context);
static HRESULT fp_dwrite_static_font_file_stream__get_file_size(FP_DWrite_FontFileStream *obj, UINT64 *size_out);
static HRESULT fp_dwrite_static_font_file_stream__get_last_write_time(FP_DWrite_FontFileStream *obj, UINT64 *time_out);
