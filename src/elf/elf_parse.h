...
internal String8         elf_name_from_shdr64(String8 raw_data, ELF_Hdr64 *hdr, Rng1uint64 sh_name_range, ELF_Shdr64 *shdr);
internal uint64             elf_base_addr_from_bin(ELF_Hdr64 *hdr);
