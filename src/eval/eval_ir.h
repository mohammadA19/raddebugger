...
void e_oplist_push_uconst(Arena *arena, E_OpList *list, ulong x);
void e_oplist_push_sconst(Arena *arena, E_OpList *list, long x);
...
E_IRNode *e_irtree_const_u(Arena *arena, ulong v);
