...
void e_oplist_push_string_literal(Arena* arena, E_OpList* list, StringView str);
...
E_IRNode* e_irtree_const_u(Arena* arena, uint64 v);
...
E_IRNode* e_irtree_string_literal(Arena* arena, StringView str);
