...
global @(rodata) E_Member e_member_nil = {E_MemberKind_Null};
global @(rodata) E_Type e_type_nil = {E_TypeKind_Null};
...
global @(rodata) E_TypeExpandRule e_type_expand_rule__default =
{
