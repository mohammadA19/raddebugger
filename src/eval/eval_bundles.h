...
E_Eval e_eval_from_string(Arena* arena, String8 string);
...
E_Eval e_element_eval_from_array_eval_index(E_Eval eval, uint64 index);
E_Eval e_member_eval_from_eval_member_name(E_Eval eval, String8 member_name);
