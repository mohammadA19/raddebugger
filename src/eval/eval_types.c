...
e_type_kind_from_base(TypeKind kind)
{
  ...
  switch(kind)
  {
    ...
    case TypeKind_uint8:    {result = E_TypeKind_uint8;}break;
    case TypeKind_uint16:   {result = E_TypeKind_uint16;}break;
    case TypeKind_uint32:   {result = E_TypeKind_uint32;}break;
    case TypeKind_uint64:   {result = E_TypeKind_uint64;}break;
    case TypeKind_uint8:    {result = E_TypeKind_uint8;}break;
    case TypeKind_uint16:   {result = E_TypeKind_uint16;}break;
    case TypeKind_uint32:   {result = E_TypeKind_uint32;}break;
    case TypeKind_uint64:   {result = E_TypeKind_uint64;}break;
    case TypeKind_B8:    {result = E_TypeKind_uint8;}break;
    case TypeKind_B16:   {result = E_TypeKind_uint16;}break;
    case TypeKind_B32:   {result = E_TypeKind_uint32;}break;
    case TypeKind_B64:   {result = E_TypeKind_uint64;}break;
    case TypeKind_float:   {result = E_TypeKind_float;}break;
    case TypeKind_double:   {result = E_TypeKind_double;}break;
...
e_type_kind_from_rdi(RDI_TypeKind kind)
{
  ...
  switch(kind)
  {
    ...
    case RDI_TypeKind_uint8:                     {result = E_TypeKind_uint8;}break;
    case RDI_TypeKind_uint16:                    {result = E_TypeKind_uint16;}break;
    case RDI_TypeKind_uint32:                    {result = E_TypeKind_uint32;}break;
    case RDI_TypeKind_uint64:                    {result = E_TypeKind_uint64;}break;
    case RDI_TypeKind_uint128:                   {result = E_TypeKind_uint128;}break;
    ...
    case RDI_TypeKind_float:                    {result = E_TypeKind_float;}break;
    case RDI_TypeKind_floatPP:                  {result = E_TypeKind_floatPP;}break;
    case RDI_TypeKind_F48:                    {result = E_TypeKind_F48;}break;
    case RDI_TypeKind_double:                    {result = E_TypeKind_double;}break;
    case RDI_TypeKind_F80:                    {result = E_TypeKind_F80;}break;
    case RDI_TypeKind_F128:                   {result = E_TypeKind_F128;}break;
    case RDI_TypeKind_Complexfloat:             {result = E_TypeKind_Complexfloat;}break;
    case RDI_TypeKind_Complexdouble:             {result = E_TypeKind_Complexdouble;}break;
...
e_type_group_from_kind(E_TypeKind kind)
{
  ...
  switch(kind)
  {
    ...
    case E_TypeKind_F16:  case E_TypeKind_floatPP: case E_TypeKind_F48:
    case E_TypeKind_F80:  case E_TypeKind_F128:
    case E_TypeKind_Complexfloat: case E_TypeKind_Complexdouble:
    ...
    case E_TypeKind_uint8:     case E_TypeKind_uint16:     case E_TypeKind_uint32:
    case E_TypeKind_uint64:    case E_TypeKind_uint128:    case E_TypeKind_U256:
    ...
    case E_TypeKind_uint8:    case E_TypeKind_uint16:    case E_TypeKind_uint32:
    case E_TypeKind_uint64:   case E_TypeKind_uint128:   case E_TypeKind_S256:
    case E_TypeKind_S512:
    case E_TypeKind_Bool:
    {result = RDI_EvalTypeGroup_S;}break;
    
    case E_TypeKind_float:{result = RDI_EvalTypeGroup_float;}break;
    case E_TypeKind_double:{result = RDI_EvalTypeGroup_double;}break;
  }
  return result;
}
...
e_type_key_basic(E_TypeKind kind)
{
  ...
  key.u32[0] = (uint32)kind;
  return key;
}

internal E_TypeKey
e_type_key_ext(E_TypeKind kind, uint32 type_idx, uint32 rdi_idx)
{
...
e_type_key_reg(Arch arch, REGS_RegCode code)
{
  ...
  key.u32[0] = (uint32)arch;
  key.u32[1] = (uint32)code;
  return key;
}
...
e_hash_from_cons_type_params(E_ConsTypeParams *params)
{
  uint32 buffer[] =
  {
    ...
    (uint32)((params->depth & 0x00000000ffffffffull)>> 0),
    (uint32)((params->depth & 0xffffffff00000000ull)>> 32),
  };
...
e_type_key_cons_(E_ConsTypeParams *params)
{
  ...
  uint64 content_slot_idx = content_hash%e_cache->cons_content_slots_count;
  ...
  if(node == 0)
  {
    ...
    key.u32[1] = (uint32)e_cache->cons_id_gen;
    e_cache->cons_id_gen += 1;
    uint64 key_hash = e_hash_from_string(5381, str8_struct(&key));
    uint64 key_slot_idx = key_hash%e_cache->cons_key_slots_count;
...
internal E_TypeKey
e_type_key_cons_array(E_TypeKey element_type_key, uint64 count, E_TypeFlags flags)
{
...
internal E_TypeKey
e_type_key_cons_ptr(Arch arch, E_TypeKey element_type_key, uint64 count, E_TypeFlags flags)
{
  ...
  uint64 reg_byte_count = 0;
  {
    switch(key.kind)
    {
      ...
      case E_TypeKeyKind_Reg:
      {
        ...
        reg_byte_count = (uint64)rng.byte_size;
      }goto build_reg_type;
      case E_TypeKeyKind_RegAlias:
      {
        ...
        reg_byte_count = (uint64)slice.byte_size;
      }goto build_reg_type;
      build_reg_type:
      {
        ...
        E_MemberList members = {0};
        {
          // rjf: build exact-sized members
          {
            if(type->byte_size == 16)
            {
              ...
              mem->type_key = e_type_key_basic(E_TypeKind_uint128);
            }
            if(type->byte_size == 8)
            {
              E_MemberNode *n = push_array(scratch.arena, E_MemberNode, 1);
              ...
              mem->type_key = e_type_key_basic(E_TypeKind_uint64);
            }
            if(type->byte_size == 4)
            {
              E_MemberNode *n = push_array(scratch.arena, E_MemberNode, 1);
              ...
              mem->type_key = e_type_key_basic(E_TypeKind_uint32);
            }
            if(type->byte_size == 2)
            {
              E_MemberNode *n = push_array(scratch.arena, E_MemberNode, 1);
              ...
              mem->type_key = e_type_key_basic(E_TypeKind_uint16);
            }
            if(type->byte_size == 1)
            {
              E_MemberNode *n = push_array(scratch.arena, E_MemberNode, 1);
              ...
              mem->type_key = e_type_key_basic(E_TypeKind_uint8);
            }
          }
          ...
          // rjf: build arrays for subdivisions
          {
            if(type->byte_size > 16 && type->byte_size%16 == 0)
            {
              ...
              mem->type_key = e_type_key_cons_array(e_type_key_basic(E_TypeKind_uint128), reg_byte_count/16, 0);
            }
            if(type->byte_size > 8 && type->byte_size%8 == 0)
            {
              ...
              mem->type_key = e_type_key_cons_array(e_type_key_basic(E_TypeKind_uint64), reg_byte_count/8, 0);
            }
            if(type->byte_size > 4 && type->byte_size%4 == 0)
            {
              ...
              mem->type_key = e_type_key_cons_array(e_type_key_basic(E_TypeKind_uint32), reg_byte_count/4, 0);
            }
            if(type->byte_size > 2 && type->byte_size%2 == 0)
            {
              ...
              mem->type_key = e_type_key_cons_array(e_type_key_basic(E_TypeKind_uint16), reg_byte_count/2, 0);
            }
            if(type->byte_size > 1)
            {
              E_MemberNode *n = push_array(scratch.arena, E_MemberNode, 1);
              ...
              mem->type_key = e_type_key_cons_array(e_type_key_basic(E_TypeKind_uint8), reg_byte_count, E_TypeFlag_IsNotText);
            }
            if(type->byte_size > 4 && type->byte_size%4 == 0)
            {
              E_MemberNode *n = push_array(scratch.arena, E_MemberNode, 1);
              ...
              mem->type_key = e_type_key_cons_array(e_type_key_basic(E_TypeKind_float), reg_byte_count/4, 0);
            }
            if(type->byte_size > 8 && type->byte_size%8 == 0)
            {
              E_MemberNode *n = push_array(scratch.arena, E_MemberNode, 1);
              ...
              mem->type_key = e_type_key_cons_array(e_type_key_basic(E_TypeKind_double), reg_byte_count/8, 0);
            }
          }
        }
...
e_type_data_members_from_key(Arena *arena, E_TypeKey key)
{
  ...
  if((root_type_kind == E_TypeKind_Struct || root_type_kind == E_TypeKind_Class) && key.kind != E_TypeKeyKind_Cons)
  {
    for(uint64 idx = 0; idx < members.count; idx += 1)
    {
      ...
      if(idx+1 < members.count)
      {
        ...
        Rng1uint64 member_byte_range = r1u64(member->off, member->off + member_byte_size);
  ...
  if(padding_count != 0)
  {
    ...
    for(PaddingNode *n = first_padding; n != 0; n = n->next)
    {
      ...
      padding_member->type_key = e_type_key_cons_array(e_type_key_basic(E_TypeKind_uint8), n->size, E_TypeFlag_IsNotText);
...
e_type_key_promote(E_TypeKey key)
{
  ...
  if(kind == E_TypeKind_Bool ||
     kind == E_TypeKind_uint8 ||
     kind == E_TypeKind_uint16 ||
     kind == E_TypeKind_uint8 ||
     kind == E_TypeKind_uint16)
  {
    result = e_type_key_basic(E_TypeKind_uint32);
  }
  return result;
}
...
internal void
e_type_rhs_string_from_key(Arena *arena, E_TypeKey key, String8List *out, uint32 prec)
{
  E_TypeKind kind = e_type_kind_from_key(key);
  switch(kind)
  {
...
e_type_from_key(E_TypeKey key)
{
  E_Type *type = &e_type_nil;
  {
    ...
    uint64 slot_idx = hash%e_cache->type_cache_slots_count;
...
{
  uint64 hash = e_hash_from_string(5381, str8_struct(&key));
  uint64 slot_idx = hash%e_cache->member_cache_slots_count;
...
e_type_data_members_from_key_filter__cached(E_TypeKey key, String8 filter)
{
  ...
  if(node != 0)
  {
    ...
    {
      uint64 hash = e_hash_from_string(5381, filter);
      uint64 slot_idx = hash%node->member_filter_slots_count;
...
{
  uint64 hash = e_hash_from_string(5381, str8_struct(&key));
  uint64 slot_idx = hash%e_cache->enum_val_cache_slots_count;
  ...
  if(node == 0)
  {
    ...
    if(type->kind == E_TypeKind_Enum)
    {
      ...
      for EachIndex(idx, type->count)
      {
        uint64 hash = e_hash_from_string(5381, type->enum_vals[idx].name);
        uint64 slot_idx = hash%node->val_hash_slots_count;
...
e_type_enum_vals_from_key_filter__cached(E_TypeKey key, String8 filter)
{
  ...
  if(node != 0)
  {
    ...
    {
      uint64 hash = e_hash_from_string(5381, filter);
      uint64 slot_idx = hash%node->val_filter_slots_count;
...
E_TYPE_EXPAND_RANGE_FUNCTION_DEF(default)
{
  Temp scratch = scratch_begin(&arena, 1);
  {
    ...
    {
      E_MemberArray data_members = e_type_data_members_from_key_filter__cached(expand_type_key, filter);
      Rng1uint64 legal_idx_range = r1u64(0, data_members.count);
      ...
      {
        uint64 member_idx = idx + read_range.min;
    ...
    else if(expand_type_kind == E_TypeKind_Enum)
    {
      ...
      E_EnumValArray enum_vals = e_type_enum_vals_from_key_filter__cached(expand_type_key, filter);
      Rng1uint64 legal_idx_range = r1u64(0, enum_vals.count);
      Rng1uint64 read_range = intersect_1u64(legal_idx_range, idx_range);
      uint64 read_range_count = dim_1u64(read_range);
      for(uint64 idx = 0; idx < read_range_count; idx += 1)
      {
        uint64 val_idx = idx + read_range.min;
    ...
    {
      uint64 read_range_count = dim_1u64(idx_range);
      for(uint64 idx = 0; idx < read_range_count; idx += 1)
      {
...
E_TYPE_EXPAND_INFO_FUNCTION_DEF(rows)
{
  ...
  accel->root_evals_ranges = push_array(arena, Rng1uint64, type->count);
...
E_TYPE_EXPAND_INFO_FUNCTION_DEF(folder)
{
  E_TypeExpandInfo info = {0};
  {
    ...
    uint64 lhs_string_id = eval.value.u64;
    ...
    {
      uint64 folder_pos_in_filter = str8_find_needle(filter, 0, folder_path, StringMatchFlag_CaseInsensitive|StringMatchFlag_SlashInsensitive);
...
E_TYPE_EXPAND_NUM_FROM_ID_FUNCTION_DEF(folder)
{
  uint64 num = 0;
  E_FolderAccel *accel = (E_FolderAccel *)user_data;
  for(uint64 idx = 0; idx < accel->folders.count+accel->files.count; idx += 1)
  {
    String8 name = {0};
    if(0 <= idx && idx < accel->folders.count)
    {
...
E_TYPE_IREXT_FUNCTION_DEF(file)
{
  ...
  E_FileAccel *accel = push_array(arena, E_FileAccel, 1);
  {
    ...
    uint64 lhs_string_id = lhs_value.u64;
...
E_TYPE_ACCESS_FUNCTION_DEF(file)
{
  ...
  if(expr->kind == E_ExprKind_MemberAccess)
  {
    ...
    else if(str8_match(member_name, str8_lit("data"), 0))
    {
      ...
      result.type_key = e_type_key_cons_array(e_type_key_basic(E_TypeKind_uint8), accel->props.size, 0);
      result.mode = E_Mode_Offset;
    }
  }
  return result;
