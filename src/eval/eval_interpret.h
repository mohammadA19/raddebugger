...
static void e_select_interpret_ctx(E_InterpretCtx *ctx, RDI_Parsed *primary_rdi, U64 ip_voff);

////////////////////////////////
//~ rjf: Space Reading Helpers

static U64 e_space_gen(E_Space space);
static B32 e_space_read(E_Space space, void *out, Rng1U64 range);
static B32 e_space_write(E_Space space, void *in, Rng1U64 range);

////////////////////////////////
//~ rjf: Interpretation Functions

static E_Interpretation e_interpret(String8 bytecode);
