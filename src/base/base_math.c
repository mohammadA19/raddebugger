...
internal Mat4x4float
transpose_4x4f32(Mat4x4float mat)
{
  Mat4x4float result =
  {
    {
...
internal Vec3float
linear_from_srgb(Vec3float srgb)
{
  Vec3float result;
...
internal Vec3float
srgb_from_linear(Vec3float linear)
{
  Vec3float result;
...
internal Vec4float
linear_from_srgba(Vec4float srgba)
{
  Vec4float result;
...
internal Vec4float
srgba_from_linear(Vec4float linear)
{
  Vec4float result;
...
internal Vec3float
oklab_from_linear(Vec3float linear)
{
...
internal Vec3float
linear_from_oklab(Vec3float oklab)
{
...
internal Vec4float
oklab_from_lineara(Vec4float lineara)
{
  Vec4float result;
...
internal Vec4float
lineara_from_oklab(Vec4float oklab)
{
  Vec4float result;
...
internal uint64
rng_1u64_array_bsearch(Rng1uint64Array arr, uint64 value)
{
  if(arr.count > 0 && arr.v[0].min < value && value < arr.v[arr.count-1].max)
  {
    uint64 l = 0;
    uint64 r = arr.count - 1;
    for(; l <= r; )
    {
      uint64 m = l + (r - l) / 2;
