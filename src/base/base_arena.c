...
public static Arena* arena_alloc_(ArenaParams* @params)
{
...
public static void arena_release(Arena* arena)
{
...
public static void* arena_push(Arena* arena, uint64 size, uint64 align)
{
...
public static uint64 arena_pos(Arena* arena)
{
  Arena* current = arena.current;
...
public static void arena_pop_to(Arena* arena, uint64 pos)
{
...
public static void arena_clear(Arena* arena)
{
  arena_pop_to(arena, 0);
}

public static void arena_pop(Arena* arena, uint64 amt)
{
...
public static Temp temp_begin(Arena* arena)
{
...
public static void temp_end(Temp temp)
{
