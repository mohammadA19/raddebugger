...
public static void* arena_push(Arena* arena, U64 size, U64 align)
{
...
public static U64 arena_pos(Arena* arena)
{
  Arena* current = arena.current;
...
public static void arena_pop_to(Arena* arena, U64 pos)
{
...
public static void arena_pop(Arena* arena, U64 amt)
{
