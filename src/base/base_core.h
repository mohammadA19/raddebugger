...
internal ulong bit_size_from_arch(Arch arch);
internal ulong max_instruction_size_from_arch(Arch arch);
...
internal DateTime  date_time_from_unix_time(ulong unix_time);
