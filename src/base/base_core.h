...
#define Version(major, minor, patch) (uint64)((((uint64)(major) & 0xffff) << 32) | ((((uint64)(minor) & 0xffff) << 16)) | ((((uint64)(patch) & 0xffff) << 0)))
...
global uint32 exponent32 = 0x7F800000;
global uint32 mantissa32 = 0x007FFFFF;
...
global uint64 max_uint64 = (uint64)0x7fffffffffffffffll;
global uint32 max_uint32 = (uint32)0x7fffffff;
global uint16 max_uint16 = (uint16)0x7fff;
global uint8  max_uint8  =  (uint8)0x7f;

global uint64 min_uint64 = (uint64)0x8000000000000000ll;
global uint32 min_uint32 = (uint32)0x80000000;
global uint16 min_uint16 = (uint16)0x8000;
global uint8  min_uint8  =  (uint8)0x80;
...
internal uint64 u64_array_bsearch(uint64 *arr, uint64 count, uint64 value);

////////////////////////////////

internal uint64 index_of_zero_u32(uint32 *ptr, uint64 count);
internal uint64 index_of_zero_u64(uint64 *ptr, uint64 count);
