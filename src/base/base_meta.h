...
static Member *member_from_name(Type *type, String8 name);
...
static void typed_data_rebase_ptrs(Type *type, String8 data, void *base_ptr);
static String8 serialized_from_typed_data(Arena *arena, Type *type, String8 data, TypeSerializeParams *params);
static String8 deserialized_from_typed_data(Arena *arena, Type *type, String8 data, TypeSerializeParams *params);
static String8 deep_copy_from_typed_data(Arena *arena, Type *type, String8 data, TypeSerializeParams *params);
