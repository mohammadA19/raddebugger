...
ulong str8_find_needle_reverse(String8 string, ulong start_pos, String8 needle, StringMatchFlags flags);
...
uint u32_from_str8(String8 string, uint radix);
int s32_from_str8(String8 string, uint radix);
B32 try_u64_from_str8_c_rules(String8 string, ulong *x);
B32 try_s64_from_str8_c_rules(String8 string, long *x);

//- rjf: integer -> string
String8 str8_from_memory_size(Arena *arena, ulong size);
String8 str8_from_count(Arena *arena, ulong count);
String8 str8_from_bits_u32(Arena *arena, uint x);
String8 str8_from_bits_u64(Arena *arena, ulong x);
...
void * str8_deserial_get_raw_ptr(String8 string, ulong off, ulong size);
ulong    str8_deserial_read_cstr(String8 string, ulong off, String8 *cstr_out);
...
ulong    str8_deserial_read_uleb128(String8 string, ulong off, ulong *value_out);
ulong    str8_deserial_read_sleb128(String8 string, ulong off, long *value_out);
