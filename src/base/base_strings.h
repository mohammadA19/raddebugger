...
internal String8List numeric_str8_list_from_data(Arena *arena, uint32 radix, String8 data, uint64 stride);
...
internal uint64 version_from_str8(String8 string);
internal String8 str8_from_version(Arena *arena, uint64 version);
...
internal uint64 u64_hash_from_seed_str8(uint64 seed, String8 string);
internal uint64 u64_hash_from_str8(String8 string);
